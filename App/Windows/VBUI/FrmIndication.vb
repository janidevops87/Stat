Option Strict Off
Option Explicit On
Friend Class FrmIndication
	Inherits System.Windows.Forms.Form
	
	'Form Variables
	Dim fvFormState As Short
	Dim fvIndicationID As Integer
    ...
    Public Property IndicationID() As Object
        Get

            IndicationID = fvIndicationID

        End Get
        Set(ByVal Value As Object)

            fvIndicationID = Value
    ...
    Private Sub CmdOK_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles CmdOK.Click
        ...
        'Validate the data
        If Not modStatValidate.Indication(Me) Then
            Exit Sub
        End If

        'Create a new record and
        'get the ID
        Me.IndicationID = modStatSave.SaveIndication(Me)

        If ChkHighRisk.Visible = True Then
            'modStatSave.SaveCriteriaGroupIndicationProperties
        End If
    ...
    Private Sub FrmIndication_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        ...
        ElseIf Me.FormState = EXISTING_RECORD Then
            ...
            'Get the Indication record detail
    ...
    Private Sub FrmIndication_FormClosing(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
