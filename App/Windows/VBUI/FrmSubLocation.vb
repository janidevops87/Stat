...
Friend Class FrmSubLocation
    ...
    Private Sub CmdOK_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles CmdOK.Click
        ...
        'Validate the data
        If Not modStatValidate.SubLocation(Me) Then
            Exit Sub
        End If

        'Create a new record and
        'get the ID
        Me.SubLocationID = modStatSave.SaveSubLocation(Me)
        Me.Saved = True
    ...
    Private Sub FrmSubLocation_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        ...
        ElseIf Me.FormState = EXISTING_RECORD Then
            ...
            Call modStatQuery.QuerySubLocation(Me)
    ...
    Private Sub FrmSubLocation_FormClosing(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
