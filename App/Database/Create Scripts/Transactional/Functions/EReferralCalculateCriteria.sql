...
IF EXISTS (SELECT * FROM sysobjects WHERE  name = 'EReferralCalculateCriteria')
	BEGIN
		PRINT 'Dropping Function EReferralCalculateCriteria'
		DROP Function EReferralCalculateCriteria
	END
GO

PRINT 'Creating Function EReferralCalculateCriteria' 
GO 

CREATE FUNCTION dbo.EReferralCalculateCriteria 
(
	@Age INT,
	@AgeUnit INT, 
	@Gender INT, 
...
--Constants
	...
	--set organ to not appropriate -- heartbeat will always be no through e-referral
	UPDATE @Category
