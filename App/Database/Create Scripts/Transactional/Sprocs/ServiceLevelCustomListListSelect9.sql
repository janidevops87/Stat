...
IF EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND name = 'ServiceLevelCustomListListSelect9')
	BEGIN
		PRINT 'Dropping Procedure ServiceLevelCustomListListSelect9'
		DROP Procedure ServiceLevelCustomListListSelect9
	END
GO

PRINT 'Creating Procedure ServiceLevelCustomListListSelect9'
GO
CREATE Procedure ServiceLevelCustomListListSelect9
(
...
*******************************************************************************/
	...
	WHERE 
		...
		and ServiceLevelListField = 9
	ORDER BY 2
GO

GRANT EXEC ON ServiceLevelCustomListListSelect9 TO PUBLIC
GO
