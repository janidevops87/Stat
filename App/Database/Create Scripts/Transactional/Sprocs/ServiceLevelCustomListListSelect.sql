...
IF EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND name = 'ServiceLevelCustomListListSelect')
	BEGIN
		PRINT 'Dropping Procedure ServiceLevelCustomListListSelect'
		DROP Procedure ServiceLevelCustomListListSelect
	END
GO

PRINT 'Creating Procedure ServiceLevelCustomListListSelect'
GO
CREATE Procedure ServiceLevelCustomListListSelect
(
