IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'GetReferralList')
	BEGIN
		PRINT 'Dropping Procedure GetReferralList'
		DROP  Procedure  GetReferralList
	END

GO

PRINT 'Creating Procedure GetReferralList'
GO
CREATE Procedure GetReferralList
...
LEFT JOIN 
	Organization ON Organization.OrganizationID = Referral.ReferralCallerOrganizationID LEFT JOIN 
...
GRANT EXEC ON GetReferralList TO PUBLIC
