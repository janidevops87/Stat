...
<%@ Control Language="c#" AutoEventWireup="True" Codebehind="LoginControl.ascx.cs" Inherits="Statline.Registry.Web.UI.Controls.LoginControl" targetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" enableViewState="False"%>
...
<TABLE id="loginOuterTable" cssclass="PageBorder" cellSpacing="0" cellPadding="10" width="100%"
	border="0">
	<TR>
		<TD><cc1:sectionheader id="topSectionHeader" Width="100%" CssClass="SectionHeader" Text="Statline Reports Login"
					...
					<TD>
						<TABLE id="loginTable" cellSpacing="1" cellPadding="1" width="100%" border="0">
							<TR>
								...
								<TD width="80%">
									<asp:textbox id="txtUserName" cssClass="InputText" runat="server" onkeypress="javascript:LogInKeyPressEvent();" AutoCompleteType="Disabled"></asp:textbox>
