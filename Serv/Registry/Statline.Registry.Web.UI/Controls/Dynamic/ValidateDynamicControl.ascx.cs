...
{
    public partial class ValidateDynamicControl : BaseUserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (IDologyActive == false)
            {
                ...
                {
                    QueryStringManager.Redirect(PageName.DynamicElectronicSignature);
                }
            }
            else
            {
        ...
        public void askAdditionalQuestions(string xmlStream)
        {
            ...
            {
                case "es" :
                    register = "Register\\Dynamic\\QuestionTemplateSp.xslt";
                    break;
                default:
                    register = "Register\\Dynamic\\QuestionTemplate.xslt";
                    break;
            }
