...
{
    public partial class ElectronicSignatureMobileControl : BaseUserControl
    {
        ...
        String AddEmailSubject = "";
        String  AddEmailBody = "";

        String  AddEmailInvitationSubject = "";
        String  AddEmailInvitationBody = "";

        String  RemoveEmailSubject = "";
        String  RemoveEmailBody = "";

        String EmailFromAddress = "";

        String EmailMailboxAccount = "";
       ...
       private void GetSessionInfo()
        {
            ...
            { //session expired while user was on ElectronicSignature Page. Try to scrape Key Session Values from hidden form values and 
                // save to session
           ...
           //Get CSS file location
            ...
            else { CSSFileLocation = "~/Framework/Themes/Default/EnrollmentMobile.css"; } //set default
        }
        ...
        protected void btnRegistration_Click(object sender, EventArgs e)
        {
            ...
            if (this.cbxConfirmation.Checked == true)
            {
                ...
                Int32 DonorID = RegistryCommonManager.GetExistingDonor(Convert.ToInt32(RegistryID), Convert.ToInt32(RegistryOwnerID), FirstName, LastName, LastFourSSN, License, DOB, 0);
                    ...
                    // Finial Confirmation
                    QueryStringManager.Redirect(PageName.DynamicEnrollmentConfirmationMobile);
                }
                else
                {
                    // button was pressed without checkbox checked. Give message 
                    DisplayMessages.Add(MessageType.ErrorMessage, "Your signature will not be submitted unless the checkbox has been selected");
                }
        ...
        protected string generateDisableSubmitButtonOnClickEventScript()
        {
            ...
            string controlID = "_ctl0__ctl0_bCR_cR_ElectronicSignatureMobile2_btnRegistration";
