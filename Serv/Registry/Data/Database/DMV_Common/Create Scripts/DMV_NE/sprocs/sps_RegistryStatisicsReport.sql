...
SET @WebCount = 
				(SELECT	Count(Donor)
				 ...
				 JOIN		DMV_Common..RegistryOwner AS RegistryOwner ON Registry.RegistryOwnerID = RegistryOwner.RegistryOwnerID
				 ...
				 WHERE		RegistryOwner.RegistryOwnerName = 'NORS' 
