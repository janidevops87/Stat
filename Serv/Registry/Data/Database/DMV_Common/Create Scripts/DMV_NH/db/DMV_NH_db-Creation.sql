...
IF EXISTS (SELECT name FROM master.dbo.sysdatabases WHERE name = N'DMV_NH')
	DROP DATABASE [DMV_NH]
GO

CREATE DATABASE [DMV_NH]  ON (NAME = N'DMV_NH_Data', FILENAME = N'r:\Data\DMV_NH_Data.MDF' , SIZE = 1630, FILEGROWTH = 10%) LOG ON (NAME = N'DMV_NH_Log', FILENAME = N's:\Log\DMV_NH_log.ldf' , SIZE = 200, FILEGROWTH = 10%)
 COLLATE SQL_Latin1_General_CP1_CI_AS
GO
ALTER DATABASE [DMV_NH] ADD FILEGROUP [IDX] 
GO
ALTER DATABASE [DMV_NH] ADD FILE(NAME = N'DMV_NH_Index', FILENAME = N't:\Index\DMV_NH_IDX.ndf' , SIZE = 570, FILEGROWTH = 10%) TO FILEGROUP [IDX]
GO

exec sp_dboption N'DMV_NH', N'autoclose', N'false'
GO

exec sp_dboption N'DMV_NH', N'bulkcopy', N'false'
GO

exec sp_dboption N'DMV_NH', N'trunc. log', N'false'
GO

exec sp_dboption N'DMV_NH', N'torn page detection', N'false'
GO

exec sp_dboption N'DMV_NH', N'read only', N'false'
GO

exec sp_dboption N'DMV_NH', N'dbo use', N'false'
GO

exec sp_dboption N'DMV_NH', N'single', N'false'
GO

exec sp_dboption N'DMV_NH', N'autoshrink', N'false'
GO

exec sp_dboption N'DMV_NH', N'ANSI null default', N'false'
GO

exec sp_dboption N'DMV_NH', N'recursive triggers', N'false'
GO

exec sp_dboption N'DMV_NH', N'ANSI nulls', N'false'
GO

exec sp_dboption N'DMV_NH', N'concat null yields null', N'false'
GO

exec sp_dboption N'DMV_NH', N'cursor close on commit', N'false'
GO

exec sp_dboption N'DMV_NH', N'default to local cursor', N'false'
GO

exec sp_dboption N'DMV_NH', N'quoted identifier', N'false'
GO

exec sp_dboption N'DMV_NH', N'ANSI warnings', N'false'
GO

exec sp_dboption N'DMV_NH', N'auto create statistics', N'true'
GO

exec sp_dboption N'DMV_NH', N'auto update statistics', N'true'
GO

if( ( (@@microsoftversion / power(2, 24) = 8) and (@@microsoftversion & 0xffff >= 724) ) or ( (@@microsoftversion / power(2, 24) = 7) and (@@microsoftversion & 0xffff >= 1082) ) )
	exec sp_dboption N'DMV_NH', N'db chaining', N'false'
GO
...
/****** Object:  Table [dbo].[DMVADDR]    Script Date: 1/11/2008 10:58:58 AM ******/
...
/****** Object:  Table [dbo].[DMVORGAN]    Script Date: 1/11/2008 10:58:58 AM ******/
...
/****** Object:  Table [dbo].[ACCESSTYPE]    Script Date: 1/11/2008 10:58:58 AM ******/
...
/****** Object:  Table [dbo].[ADDRTYPE]    Script Date: 1/11/2008 10:58:58 AM ******/
...
/****** Object:  Table [dbo].[DMV]    Script Date: 1/11/2008 10:58:58 AM ******/
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[DMV]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[DMV]
GO

/****** Object:  Table [dbo].[DMVARCHIVE]    Script Date: 1/11/2008 10:58:58 AM ******/
...
/****** Object:  Table [dbo].[DMVARCHIVEADDR]    Script Date: 1/11/2008 10:58:58 AM ******/
...
/****** Object:  Table [dbo].[DMVARCHIVEORGAN]    Script Date: 1/11/2008 10:58:58 AM ******/
...
/****** Object:  Table [dbo].[DMVARCHIVETYPE]    Script Date: 1/11/2008 10:58:58 AM ******/
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[DMVARCHIVETYPE]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[DMVARCHIVETYPE]
GO

/****** Object:  Table [dbo].[EventSourceCodes]    Script Date: 1/11/2008 10:58:58 AM ******/
...
/****** Object:  Table [dbo].[IMPORT]    Script Date: 1/11/2008 10:58:58 AM ******/
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[IMPORT]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[IMPORT]
GO

/****** Object:  Table [dbo].[IMPORTARCHIVE]    Script Date: 1/11/2008 10:58:58 AM ******/
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[IMPORTARCHIVE]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[IMPORTARCHIVE]
GO

/****** Object:  Table [dbo].[IMPORTARCHIVE_A]    Script Date: 1/11/2008 10:58:58 AM ******/
...
/****** Object:  Table [dbo].[IMPORTARCHIVE_B]    Script Date: 1/11/2008 10:58:58 AM ******/
...
/****** Object:  Table [dbo].[IMPORTARCHIVE_C]    Script Date: 1/11/2008 10:58:58 AM ******/
...
/****** Object:  Table [dbo].[IMPORTFILES]    Script Date: 1/11/2008 10:58:58 AM ******/
...
/****** Object:  Table [dbo].[IMPORTLOG]    Script Date: 1/11/2008 10:58:58 AM ******/
...
/****** Object:  Table [dbo].[IMPORTLOGSTATS]    Script Date: 1/11/2008 10:58:58 AM ******/
...
/****** Object:  Table [dbo].[IMPORT_A]    Script Date: 1/11/2008 10:58:58 AM ******/
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[IMPORT_A]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[IMPORT_A]
GO

/****** Object:  Table [dbo].[IMPORT_B]    Script Date: 1/11/2008 10:58:58 AM ******/
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[IMPORT_B]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[IMPORT_B]
GO

/****** Object:  Table [dbo].[IMPORT_C]    Script Date: 1/11/2008 10:58:58 AM ******/
...
/****** Object:  Table [dbo].[IMPORT_D]    Script Date: 1/11/2008 10:58:58 AM ******/
...
/****** Object:  Table [dbo].[Import_Adds]    Script Date: 1/11/2008 10:58:58 AM ******/
...
/****** Object:  Table [dbo].[Import_Deletes]    Script Date: 1/11/2008 10:58:58 AM ******/
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[Import_Deletes]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[Import_Deletes]
GO

/****** Object:  Table [dbo].[NH_Donor_Registry]    Script Date: 1/11/2008 10:58:58 AM ******/
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[NH_Donor_Registry]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[NH_Donor_Registry]
GO

/****** Object:  Table [dbo].[NH_OnLine_Registry]    Script Date: 1/11/2008 10:58:58 AM ******/
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[NH_OnLine_Registry]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[NH_OnLine_Registry]
GO

/****** Object:  Table [dbo].[ORGANTYPE]    Script Date: 1/11/2008 10:58:58 AM ******/
...
/****** Object:  Table [dbo].[QueryLog]    Script Date: 1/11/2008 10:58:58 AM ******/
...
/****** Object:  Table [dbo].[REGISTRY]    Script Date: 1/11/2008 10:58:58 AM ******/
...
/****** Object:  Table [dbo].[REGISTRYADDR]    Script Date: 1/11/2008 10:58:58 AM ******/
...
/****** Object:  Table [dbo].[REGISTRYARCHIVE]    Script Date: 1/11/2008 10:58:58 AM ******/
...
/****** Object:  Table [dbo].[REGISTRYARCHIVEADDR]    Script Date: 1/11/2008 10:58:58 AM ******/
...
/****** Object:  Table [dbo].[REGISTRYARCHIVETYPE]    Script Date: 1/11/2008 10:58:58 AM ******/
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[REGISTRYARCHIVETYPE]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[REGISTRYARCHIVETYPE]
GO

/****** Object:  Table [dbo].[REGISTRYORGAN]    Script Date: 1/11/2008 10:58:58 AM ******/
...
/****** Object:  Table [dbo].[RegistryEventSourceCodes]    Script Date: 1/11/2008 10:58:58 AM ******/
...
/****** Object:  Table [dbo].[SUSPENSE]    Script Date: 1/11/2008 10:58:58 AM ******/
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[SUSPENSE]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[SUSPENSE]
GO

/****** Object:  Table [dbo].[SUSPENSE_A]    Script Date: 1/11/2008 10:58:58 AM ******/
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[SUSPENSE_A]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[SUSPENSE_A]
GO

/****** Object:  Table [dbo].[SUSPENSE_B]    Script Date: 1/11/2008 10:58:58 AM ******/
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[SUSPENSE_B]') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
drop table [dbo].[SUSPENSE_B]
GO

/****** Object:  Table [dbo].[SUSPENSE_C]    Script Date: 1/11/2008 10:58:58 AM ******/
...
/****** Object:  Table [dbo].[WEBUSER]    Script Date: 1/11/2008 10:58:58 AM ******/
...
/****** Object:  Table [dbo].[legacy]    Script Date: 1/11/2008 10:58:58 AM ******/
...
BEGIN
	declare @logindb nvarchar(132), @loginlang nvarchar(132) select @logindb = N'DMV_NH', @loginlang = N'us_english'
	if @logindb is null or not exists (select * from master.dbo.sysdatabases where name = @logindb)
		select @logindb = N'master'
	if @loginlang is null or (not exists (select * from master.dbo.syslanguages where name = @loginlang) and @loginlang <> N'us_english')
		select @loginlang = @@language
...
/****** Object:  Table [dbo].[ACCESSTYPE]    Script Date: 1/11/2008 10:59:01 AM ******/
...
/****** Object:  Table [dbo].[ADDRTYPE]    Script Date: 1/11/2008 10:59:02 AM ******/
...
/****** Object:  Table [dbo].[DMV]    Script Date: 1/11/2008 10:59:02 AM ******/
...
/****** Object:  Table [dbo].[DMVARCHIVE]    Script Date: 1/11/2008 10:59:03 AM ******/
...
/****** Object:  Table [dbo].[DMVARCHIVEADDR]    Script Date: 1/11/2008 10:59:03 AM ******/
...
/****** Object:  Table [dbo].[DMVARCHIVEORGAN]    Script Date: 1/11/2008 10:59:03 AM ******/
...
/****** Object:  Table [dbo].[DMVARCHIVETYPE]    Script Date: 1/11/2008 10:59:03 AM ******/
...
/****** Object:  Table [dbo].[EventSourceCodes]    Script Date: 1/11/2008 10:59:04 AM ******/
...
/****** Object:  Table [dbo].[IMPORT]    Script Date: 1/11/2008 10:59:04 AM ******/
...
/****** Object:  Table [dbo].[IMPORTARCHIVE]    Script Date: 1/11/2008 10:59:04 AM ******/
...
/****** Object:  Table [dbo].[IMPORTARCHIVE_A]    Script Date: 1/11/2008 10:59:04 AM ******/
...
/****** Object:  Table [dbo].[IMPORTARCHIVE_B]    Script Date: 1/11/2008 10:59:05 AM ******/
...
/****** Object:  Table [dbo].[IMPORTARCHIVE_C]    Script Date: 1/11/2008 10:59:05 AM ******/
...
/****** Object:  Table [dbo].[IMPORTFILES]    Script Date: 1/11/2008 10:59:05 AM ******/
...
/****** Object:  Table [dbo].[IMPORTLOG]    Script Date: 1/11/2008 10:59:05 AM ******/
...
/****** Object:  Table [dbo].[IMPORTLOGSTATS]    Script Date: 1/11/2008 10:59:05 AM ******/
...
/****** Object:  Table [dbo].[IMPORT_A]    Script Date: 1/11/2008 10:59:06 AM ******/
...
/****** Object:  Table [dbo].[IMPORT_B]    Script Date: 1/11/2008 10:59:06 AM ******/
...
/****** Object:  Table [dbo].[IMPORT_C]    Script Date: 1/11/2008 10:59:07 AM ******/
...
/****** Object:  Table [dbo].[IMPORT_D]    Script Date: 1/11/2008 10:59:07 AM ******/
...
/****** Object:  Table [dbo].[Import_Adds]    Script Date: 1/11/2008 10:59:07 AM ******/
...
/****** Object:  Table [dbo].[Import_Deletes]    Script Date: 1/11/2008 10:59:07 AM ******/
...
/****** Object:  Table [dbo].[NH_Donor_Registry]    Script Date: 1/11/2008 10:59:08 AM ******/
CREATE TABLE [dbo].[NH_Donor_Registry] (
...
/****** Object:  Table [dbo].[NH_OnLine_Registry]    Script Date: 1/11/2008 10:59:08 AM ******/
CREATE TABLE [dbo].[NH_OnLine_Registry] (
...
/****** Object:  Table [dbo].[ORGANTYPE]    Script Date: 1/11/2008 10:59:08 AM ******/
...
/****** Object:  Table [dbo].[QueryLog]    Script Date: 1/11/2008 10:59:08 AM ******/
...
/****** Object:  Table [dbo].[REGISTRY]    Script Date: 1/11/2008 10:59:08 AM ******/
...
/****** Object:  Table [dbo].[REGISTRYADDR]    Script Date: 1/11/2008 10:59:09 AM ******/
...
/****** Object:  Table [dbo].[REGISTRYARCHIVE]    Script Date: 1/11/2008 10:59:09 AM ******/
...
/****** Object:  Table [dbo].[REGISTRYARCHIVEADDR]    Script Date: 1/11/2008 10:59:09 AM ******/
...
/****** Object:  Table [dbo].[REGISTRYARCHIVETYPE]    Script Date: 1/11/2008 10:59:10 AM ******/
...
/****** Object:  Table [dbo].[REGISTRYORGAN]    Script Date: 1/11/2008 10:59:10 AM ******/
...
/****** Object:  Table [dbo].[RegistryEventSourceCodes]    Script Date: 1/11/2008 10:59:10 AM ******/
...
/****** Object:  Table [dbo].[SUSPENSE]    Script Date: 1/11/2008 10:59:10 AM ******/
...
/****** Object:  Table [dbo].[SUSPENSE_A]    Script Date: 1/11/2008 10:59:10 AM ******/
...
/****** Object:  Table [dbo].[SUSPENSE_B]    Script Date: 1/11/2008 10:59:11 AM ******/
...
/****** Object:  Table [dbo].[SUSPENSE_C]    Script Date: 1/11/2008 10:59:11 AM ******/
...
/****** Object:  Table [dbo].[WEBUSER]    Script Date: 1/11/2008 10:59:11 AM ******/
...
/****** Object:  Table [dbo].[legacy]    Script Date: 1/11/2008 10:59:11 AM ******/
...
/****** Object:  Table [dbo].[DMVADDR]    Script Date: 1/11/2008 10:59:11 AM ******/
...
/****** Object:  Table [dbo].[DMVORGAN]    Script Date: 1/11/2008 10:59:11 AM ******/
...
/*
	...
	Legal Information...
	 ...
	 1-888-881-7828. 
*/
        -- 1. Replace MSDB.DBO.DMV_NHIndexStatus with current databases name.
        -- declare variables
        
        -- check for table in MSDB with name of databaseindexstatus ie DMV_NHIndexStatus
        -- TableName, LastRun  
 
        --     CREATE TABLE [MSDB].[dbo].[DMV_NHIndexStatus] (
 ...
 while @@fetch_status = 0
   BEGIN
     ...
     FROM  MSDB.DBO.DMV_NHIndexStatus 
     WHERE  TableName = @tableName
     AND  IndexName = @indexName
 
            If @LastRun is null 
                 BEGIN
                   INSERT MSDB.DBO.DMV_NHIndexStatus Values(@tableName, @indexName,GetDate())
     ...
     IF @RebuildAll = 0 BREAK
            ...
            If DATEDIFF(WW,@LastRun,GetDate()) > 1
                 BEGIN
                   UPDATE MSDB.DBO.DMV_NHIndexStatus SET LastRun = GetDate() WHERE TableName = @tableName
                  EXEC ("DBCC DBREINDEX (" + @tableName + ", " + @indexName +")")
     -- Exit while Loop
                   IF @RebuildAll = 0 BREAK
                 END   
