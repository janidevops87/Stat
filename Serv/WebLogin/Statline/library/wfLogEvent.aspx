...
<HTML>
	<HEAD>
		...
		<style>.CSSPop { LEFT: 257px; VISIBILITY: visible; BORDER-TOP-STYLE: outset; BORDER-RIGHT-STYLE: outset; BORDER-LEFT-STYLE: outset; POSITION: absolute; TOP: 34px; BACKGROUND-COLOR: activeborder; BORDER-BOTTOM-STYLE: outset }
	.CSSNoPop { VISIBILITY: hidden; BORDER-TOP-STYLE: none; BORDER-RIGHT-STYLE: none; BORDER-LEFT-STYLE: none; TOP: 34px; BACKGROUND-COLOR: transparent; BORDER-BOTTOM-STYLE: none }
		</style>
	</HEAD>
	<BODY bgColor="buttonface" oncontextmenu="return false">
		...
		<form id="Form1" onkeyup="maskEdit();" method="post" runat="server">
			<asp:button id="cmdCancel" style="Z-INDEX: 103; LEFT: 546px; POSITION: absolute; TOP: 107px"
				tabIndex="11" runat="server" Height="23px" Width="88px" Text="Cancel"></asp:button>
			<asp:textbox id="txtContactDate" style="Z-INDEX: 106; LEFT: 57px; POSITION: absolute; TOP: 10px"
				runat="server" Width="98px" Height="20px" MaxLength="15">00/00/00 00:00</asp:textbox><asp:textbox id="txtContactDesc" style="Z-INDEX: 105; LEFT: 258px; POSITION: absolute; TOP: 34px"
				tabIndex="8" runat="server" Height="94px" Width="272px" MaxLength="999" TextMode="MultiLine"></asp:textbox><asp:button id="cmdOK" style="Z-INDEX: 102; LEFT: 545px; POSITION: absolute; TOP: 10px" tabIndex="9"
				runat="server" Height="24px" Width="88px" Text="Save"></asp:button><asp:checkbox id="chkConfirmed" style="Z-INDEX: 104; LEFT: 546px; POSITION: absolute; TOP: 55px"
				tabIndex="10" runat="server" Height="27px" Width="81px" Text="Contact Confirmed"></asp:checkbox><asp:dropdownlist id="cboContactEventType" style="Z-INDEX: 107; LEFT: 333px; POSITION: absolute; TOP: 10px"
				tabIndex="7" runat="server" Height="17px" Width="196px" AutoPostBack="True"></asp:dropdownlist><asp:label id="lblEventType" style="Z-INDEX: 108; LEFT: 257px; POSITION: absolute; TOP: 12px"
				tabIndex="50" runat="server" Height="22px" Width="78px">Event Type</asp:label><asp:label id="Label2" style="Z-INDEX: 109; LEFT: 14px; POSITION: absolute; TOP: 11px" tabIndex="50"
				runat="server">Date</asp:label><asp:label id="lblContactName" style="Z-INDEX: 110; LEFT: 13px; POSITION: absolute; TOP: 35px"
				tabIndex="50" runat="server" Height="21px" Width="44px">Name</asp:label><asp:dropdownlist id="cboName" style="Z-INDEX: 111; LEFT: 56px; POSITION: absolute; TOP: 34px" tabIndex="1"
				runat="server" Height="17px" Width="167px" AutoPostBack="True"></asp:dropdownlist><asp:label id="lblContactOrg" style="Z-INDEX: 112; LEFT: 13px; POSITION: absolute; TOP: 55px"
				tabIndex="50" runat="server" Height="16px" Width="44px">Org</asp:label><asp:textbox id="txtContactOrg" style="Z-INDEX: 113; LEFT: 55px; POSITION: absolute; TOP: 57px"
				tabIndex="3" runat="server" Height="21px" Width="198px"></asp:textbox><asp:label id="lblContactPhone" style="Z-INDEX: 114; LEFT: 12px; POSITION: absolute; TOP: 80px"
				tabIndex="50" runat="server" Width="44px">Phone</asp:label><asp:textbox id="txtContactPhone" style="Z-INDEX: 115; LEFT: 56px; POSITION: absolute; TOP: 80px"
				tabIndex="4" runat="server" Height="23px" Width="198px" MaxLength="14"></asp:textbox><asp:textbox id="txtCalloutMins" style="Z-INDEX: 116; LEFT: 55px; POSITION: absolute; TOP: 105px"
				tabIndex="5" runat="server" Height="22px" Width="35px"></asp:textbox><asp:label id="lblCalloutUnits" style="Z-INDEX: 117; LEFT: 92px; POSITION: absolute; TOP: 110px"
				tabIndex="50" runat="server" Height="20px" Width="64px" Font-Size="X-Small">min. or after</asp:label><asp:textbox id="txtCalloutDate" style="Z-INDEX: 118; LEFT: 156px; POSITION: absolute; TOP: 105px"
				tabIndex="6" runat="server" Height="22px" Width="98px" MaxLength="15"></asp:textbox><asp:label id="lblCallout" style="Z-INDEX: 119; LEFT: 2px; POSITION: absolute; TOP: 106px"
				tabIndex="50" runat="server">Callback</asp:label>
			<asp:button id="cmdValidationMsg" style="Z-INDEX: 120; LEFT: 644px; POSITION: absolute; TOP: 25px"
				runat="server" Text="Invalid Callout Date!" Width="190px" Height="107px" BorderStyle="Dashed"
				Visible="False" CausesValidation="False" BorderColor="RosyBrown" ForeColor="Red" BackColor="#C0C0FF"
				Font-Bold="True"></asp:button><INPUT 
id=ValMsg 
style="Z-INDEX: 121; LEFT: 12px; WIDTH: 212px; POSITION: absolute; TOP: 233px; HEIGHT: 22px" 
type=hidden size=30 value=''> <INPUT 
id=ValCtl 
style="Z-INDEX: 122; LEFT: 12px; WIDTH: 211px; POSITION: absolute; TOP: 258px; HEIGHT: 23px" 
type=hidden size=29 value=''> <INPUT 
id=ValDisplayOnce 
style="Z-INDEX: 123; LEFT: 13px; WIDTH: 211px; POSITION: absolute; TOP: 284px; HEIGHT: 23px" 
type=hidden size=29 value=''> <INPUT id=OldCalloutMins 
style="Z-INDEX: 124; LEFT: 12px; WIDTH: 211px; POSITION: absolute; TOP: 207px; HEIGHT: 22px" 
type=hidden size=29 value='' name=OldCalloutMins> <INPUT id=OldCalloutDate 
style="Z-INDEX: 125; LEFT: 12px; WIDTH: 212px; POSITION: absolute; TOP: 181px; HEIGHT: 23px" 
type=hidden size=30 value='' name=OldCalloutDate>
			<asp:label id="Label3" style="Z-INDEX: 126; LEFT: 18px; POSITION: absolute; TOP: 158px" runat="server"
				Height="12px" Width="203px" Visible="False" Font-Underline="True">Hidden Fields:</asp:label><asp:panel id="pnlOtherName" style="Z-INDEX: 127; LEFT: 257px; POSITION: absolute; TOP: 133px"
				runat="server" Height="75px" Width="288px" BorderStyle="Outset" CssClass="CSSNoPop">
				<asp:Label id="Label4" runat="server" Width="280px" Font-Size="X-Small" Font-Bold="True" BackColor="Desktop"
					ForeColor="White" Font-Names="Arial">Person Name</asp:Label>
				<asp:Label id="spacer3" runat="server" Width="6px"></asp:Label>
				<asp:Label id="Label6" runat="server" Width="86px" Font-Size="X-Small" Font-Names="Arial">Person Name:</asp:Label>
				<asp:TextBox id="txtOtherName" runat="server" Width="182px" Height="24px" BorderStyle="Inset"></asp:TextBox>
				<asp:Label id="spacer4" runat="server" Width="55px"></asp:Label>
				<asp:Button id="cmdOtherName" runat="server" Text="OK" Width="67px"></asp:Button>
				<asp:Label id="spacer9" runat="server" Width="28px" Height="10px"></asp:Label>
				<asp:Button id="cmdOtherNameCancel" runat="server" Text="Cancel" Width="67px" Height="25px"></asp:Button>
			</asp:panel><INPUT id="btnNameDetail" style="Z-INDEX: 101; LEFT: 225px; WIDTH: 29px; POSITION: absolute; TOP: 34px; HEIGHT: 20px"
				onclick="popOtherNameForm();" type="button" value="...">
			<asp:DropDownList id="cboKeyCode" runat="server" style="Z-INDEX: 128; LEFT: 261px; POSITION: absolute; TOP: 279px"
				Width="212px"></asp:DropDownList>
			<asp:Label id="Label1" style="Z-INDEX: 129; LEFT: 261px; POSITION: absolute; TOP: 236px" runat="server"
				Width="195px" Font-Underline="True" Visible="False">Key Code List (Do NOT delete or set Visible to False!):</asp:Label></form>
		<script lang="javascript">
