...
<HTML>
	...
	<body oncontextmenu="return false" bgColor="activeborder">
		<form id="Form1" method="post" runat="server">
			<asp:button id="cmdNewEvent" style="Z-INDEX: 101; LEFT: 783px; POSITION: absolute; TOP: 108px"
				runat="server" Height="26px" Width="85px" Text="New Event"></asp:button><asp:datagrid id="dgLogEvent" style="Z-INDEX: 103; LEFT: 11px; POSITION: absolute; TOP: 140px"
			...
			<asp:datagrid id="dgPendingEvent" style="Z-INDEX: 102; LEFT: 299px; POSITION: absolute; TOP: 30px"
				...
				<PagerStyle NextPageText="Next &amp;gt;&amp;gt;" PrevPageText="&amp;lt;&amp;lt; Previous" Position="Top"></PagerStyle>
			</asp:datagrid><asp:textbox id="TxtEventDesc" style="Z-INDEX: 104; LEFT: 11px; POSITION: absolute; TOP: 29px"
				runat="server" Height="104px" Width="282px" TextMode="MultiLine"></asp:textbox><asp:label id="Label1" style="Z-INDEX: 105; LEFT: 11px; POSITION: absolute; TOP: 8px" runat="server"
				Width="151px">Event Description</asp:label><asp:label id="Label2" style="Z-INDEX: 106; LEFT: 299px; POSITION: absolute; TOP: 6px" runat="server"
				Width="97px">Pending Events</asp:label><input style="Z-INDEX: 107; LEFT: 11px; POSITION: absolute; TOP: 420px" type="hidden" value="this is the test string"
				name="vartest"> <INPUT style="Z-INDEX: 108; LEFT: 13px; POSITION: absolute; TOP: 450px" type="hidden" value="Joe User"
				name="DefaultContactName"> <INPUT style="Z-INDEX: 109; LEFT: 11px; POSITION: absolute; TOP: 479px" type="hidden" value="194"
				name="OrganizationId"> <input style="Z-INDEX: 110; LEFT: 12px; POSITION: absolute; TOP: 509px" type="hidden" value="0"
				name="FormState"> <INPUT style="Z-INDEX: 111; LEFT: 182px; POSITION: absolute; TOP: 421px" type="hidden"
				value="(720) 524-2913" name="DefaultContactPhone"> <INPUT style="Z-INDEX: 112; LEFT: 178px; POSITION: absolute; TOP: 455px" type="hidden"
				value="0" name="DefaultContactType"> <input style="Z-INDEX: 113; LEFT: 176px; POSITION: absolute; TOP: 487px" type="hidden"
				value="2738134" name="CallId"> <INPUT style="Z-INDEX: 114; LEFT: 179px; POSITION: absolute; TOP: 517px" type="hidden"
				value="Statline" name="DefaultOrganization"> <input style="Z-INDEX: 115; LEFT: 360px; POSITION: absolute; TOP: 423px" type="hidden"
				value="0" name="LogEventType"> <INPUT style="Z-INDEX: 116; LEFT: 350px; POSITION: absolute; TOP: 455px" type="hidden"
				value="2738134-10" name="CallNumber"> <INPUT style="Z-INDEX: 117; LEFT: 352px; POSITION: absolute; TOP: 491px" type="hidden"
				value="194" name="DefaultOrganizationID"><input style="Z-INDEX: 118; LEFT: 352px; POSITION: absolute; TOP: 520px" type="hidden"
				value="69" name="UserId"></form>
