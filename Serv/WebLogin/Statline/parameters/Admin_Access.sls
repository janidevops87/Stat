...
If AuthorizeMain Then
   ...
   RSNAV.ActiveConnection = "DSN=" & TRANSACTIONDSN & ";UID=" & DBUSER & ";Password=" & DBPWD
   RSNAV.Source = "{call dbo.SPS_NavigationPermission (" & UserID & ", 2)}"
   RSNAV.CursorType = 0
...
<table align="left" border="0" cellPadding="0" cellSpacing="0" style="WIDTH: 550px" width="550" bgColor="#112084">
        <tr>
            <td width="540"><font color=#FFFFFF face="Arial" size="4"><b>&nbsp;Administration</b></font></td>
        </tr>
    </table>
