	...
	<table border="0" width="100%" rules="NONE" frame="VOID">
		<tr>
			...
			<td ALIGN=LEFT VALIGN=TOP width="7%"><font size="<%=FontSizeHead%>" face="<%=FontNameHead%>"><b><u>Type</b></u></font></td>	
			...
			<td ALIGN=LEFT VALIGN=TOP width="24%"><font size="<%=FontSizeHead%>" face="<%=FontNameHead%>"><b><u>Of</b></u></font></td>
		</tr>  	
	</table>
...
Do Until RS.EOF = True	
	...
	<tr>
	    ...
	    <td ALIGN=LEFT VALIGN=TOP width="10%"><FONT FACE="<%=FontNameData%>" SIZE="<%=FontSizeData%>">
		  <a target="MessageDetail" href="/loginstatline/reports/message/detail.sls?CallID=<%=RS("CallID")%>&amp;UserID=<%=Request.QueryString("UserID")%>&amp;UserOrgID=<%=Request.QueryString("UserOrgID")%>&amp;DSN=<%=DataSourceName%>&amp;Options=0&NoLog=1&CountCheck=False"><%=RS("CallNumber")%></a></FONT></td>
	    <td ALIGN=LEFT VALIGN=TOP width="7%"><FONT FACE="<%=FontNameData%>" SIZE="<%=FontSizeData%>"><%=RS("MessageTypeName")%></FONT></td>	
	    ...
	    <td ALIGN=LEFT VALIGN=TOP width="24%"><FONT FACE="<%=FontNameData%>" SIZE="<%=FontSizeData%>"><%=RS("MessageCallerOrganization")%></FONT></td>
	</tr>
