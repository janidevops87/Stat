...
<FRAME SRC="CONTRACTS_HospitalPhone_TOC.sls?UserID=<%=UserID%>&UserOrgID=<%=UserOrgID%>&AsgChoice=<%=AsgChoice%>&ReportID=<%=ReportID%>&ReportName=<%=ReportName%>" NAME=toc>
<FRAME SRC="CONTRACTS_HospitalPhone_ByOrg.sls?UserID=<%=UserID%>&UserOrgID=<%=UserOrgID%>&AsgChoice=<%=AsgChoice%>&ReportID=<%=ReportID%>&ReportName=<%=ReportName%>" NAME=page>
</FRAMESET>
</HTML>
