...
<FRAME SRC="CONTRACTS_ReportsIncluded_TOC.sls?UserID=<%=UserID%>&UserOrgID=<%=UserOrgID%>&AsgChoice=<%=AsgChoice%>&ReportID=<%=ReportID%>&ReportName=<%=ReportName%>" NAME=toc>
<FRAME SRC="CONTRACTS_ReportsIncluded_ByClient.sls?UserID=<%=UserID%>&UserOrgID=<%=UserOrgID%>&AsgChoice=<%=AsgChoice%>&ReportID=<%=ReportID%>&ReportName=<%=ReportName%>" NAME=page>
</FRAMESET>
</HTML>
