		...
		If CountCheck = "False" Then
			...
			%>
				...
				%>
					...
					<!--#include virtual="/loginstatline/reports/referral/QActivitySection.sls"-->
				<%
				End If
...
Function ExecuteMain()
	...
	If pvOrderBy = "" Or pvOrderBy = "0" Then
		...
		pvOrderBy = "Referral.ReferralTypeID, CallDateTime, OrganizationName "
		pvShowSection1 = True
	Else
		If Left(pvOrderBy, 14) = "Referral.ReferralTypeID" Then
			pvShowSection1 = True
		Else
