...
Response.Write(vQuery & "<BR>")
	...
	If ReferralCount > pvCountLimit Then%>
		...
		all the memory on your computer). You may only retrieve up to <%=pvCountLimit%> records for this type of
		...
		If you would like assistance determining the best method of satisfying your reporting requirements, please contact Client Services at (888) 881-7828 x105 or email at 
