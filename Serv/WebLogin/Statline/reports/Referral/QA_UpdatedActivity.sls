...
If AuthorizeMain Then
	...
	%>
		...
		<!--#include virtual="/loginstatline/reports/referral/QA_ActivitySection.sls"-->
	<%
	Else
	%>
		No Data Available
...
Function ExecuteMain()
	...
	'Get data rows
	vQuery = "sps_UpdatedReferralActivityByAlertGroup1 '" & pvStartDate & "', '" & pvEndDate & "', " & pvReportGroupID
