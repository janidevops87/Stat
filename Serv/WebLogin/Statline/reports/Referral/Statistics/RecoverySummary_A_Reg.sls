...
If AuthorizeMain Then
	...
	'Set Title Values	
	vMainTitle = "Recovered Donor Summary (All Types - w/Reg)"
	...
	<TR>
		...
		<TD ALIGN=Left width="14%"><FONT SIZE="1" FACE="<%=FontNameHead%>"><B>Registered</B></TD>
	...
	<TR><TD COLSPAN=9><HR ALIGN=CENTER COLOR="#000000" NOSHADE SIZE=1 WIDTH="100%"></TD></TR>
...
%>
		<TR>
			...
			<TD <%=vCurrentColor%> ALIGN=Left><FONT SIZE="1" FACE="<%=FontNameHead%>"><I><%=RS("TotalRegistered")%></I></FONT></TD>
			<TD <%=vCurrentColor%> ALIGN=Left><FONT SIZE="1" FACE="<%=FontNameHead%>"><I><%=RS("AllTypes")%></I></FONT></TD>
<%
			vTotals(5) = vTotals(5) + RS("TotalRegistered")
...
%>
	...
	<TR><TD><FONT SIZE="1" FACE="<%=FontNameHead%>"><B>Totals</B></TD>
		<TD ALIGN=Left><FONT SIZE="1" FACE="<%=FontNameHead%>"><B><%=vTotals(5)%></B></FONT></TD>
