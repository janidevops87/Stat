...
<TITLE>Referral Statistics - Reason Summary</TITLE>
</HEAD>
<BODY bgColor=#F5EBDD>
...
If AuthorizeMain Then
    ...
    %>    
        ...
        If QuitPage = 0 Then    
            ...
            txtRow(0) = "No Neuro Injury"
            txtRow(1) = intCalcPercentage(DWRs("AppropriateOrganNoNeuroInjury"),pvTotals(6))
            txtRow(2) = DWRs("AppropriateOrganNoNeuroInjury")
            txtLink(2) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralOrganAppropriateID_=_7"
            txtRow(3) = intCalcPercentage(DWRs("AppropriateBoneNoNeuroInjury"),pvTotals(7))
            txtRow(4) = DWRs("AppropriateBoneNoNeuroInjury")
            txtLink(4) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralBoneAppropriateID_=_7"
            txtRow(5) = intCalcPercentage(DWRs("AppropriateTissueNoNeuroInjury"),pvTotals(8))
            txtRow(6) = DWRs("AppropriateTissueNoNeuroInjury")
            txtLink(6) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralTissueAppropriateID_=_7"
            txtRow(7) = intCalcPercentage(DWRs("AppropriateSkinNoNeuroInjury"),pvTotals(9))
            txtRow(8) = DWRs("AppropriateSkinNoNeuroInjury")
            txtLink(8) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralSkinAppropriateID_=_7"
            txtRow(9) = intCalcPercentage(DWRs("AppropriateValvesNoNeuroInjury"),pvTotals(10))
            txtRow(10) = DWRs("AppropriateValvesNoNeuroInjury")
            txtLink(10) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralValvesAppropriateID_=_7"
            txtRow(11) = intCalcPercentage(DWRs("AppropriateEyesNoNeuroInjury"),pvTotals(11))
            txtRow(12) = DWRs("AppropriateEyesNoNeuroInjury")
            txtLink(12) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralEyesTransAppropriateID_=_7"
            Call intPrintRows(txtRow,1,txtLink)
            ...
            'ccarroll 11/21/2006 added options StatTrac 8.2
            'txtRow(0) = "Prev. Discussion"
            'txtRow(1) = intCalcPercentage(DWRs("ApproachOrganPrevDiscussion"), pvTotals(6))
            'txtRow(2) = DWRs("ApproachOrganPrevDiscussion")
            'txtLink(2) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralorganApproachID_=_15_AND_ReferralOrganAppropriateID_=_1_"
            'txtRow(3) = intCalcPercentage(DWRs("ApproachBonePrevDiscussion"), pvTotals(7))
            'txtRow(4) = DWRs("ApproachBonePrevDiscussion")
            'txtLink(4) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralBoneApproachID_=_15_AND_ReferralBoneAppropriateID_=_1_"
            'txtRow(5) = intCalcPercentage(DWRs("ApproachTissuePrevDiscussion"), pvTotals(8))
            'txtRow(6) = DWRs("ApproachTissuePrevDiscussion")
            'txtLink(6) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralTissueApproachID_=_15_AND_ReferralTissueAppropriateID_=_1_"
            'txtRow(7) = intCalcPercentage(DWRs("ApproachSkinPrevDiscussion"), pvTotals(9))
            'txtRow(8) = DWRs("ApproachSkinPrevDiscussion")
            'txtLink(8) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralSkinApproachID_=_15_AND_ReferralSkinAppropriateID_=_1_"
            'txtRow(9) = intCalcPercentage(DWRs("ApproachValvesPrevDiscussion"), pvTotals(10))
            'txtRow(10) = DWRs("ApproachValvesPrevDiscussion")
            'txtLink(10) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralValvesApproachID_=_15_AND_ReferralValvesAppropriateID_=_1_"
            'txtRow(11) = intCalcPercentage(DWRs("ApproachEyesPrevDiscussion"), pvTotals(11))
            'txtRow(12) = DWRs("ApproachEyesPrevDiscussion")
            'txtLink(12) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralEyesTransApproachID_=_15_AND_ReferralEyesTransAppropriateID_=_1_"
            'Call intPrintRows(txtRow,1,txtLink)

            'txtRow(0) = "Not Pronounced"
            'txtRow(1) = intCalcPercentage(DWRs("ApproachOrganNotPronounced"), pvTotals(6))
            'txtRow(2) = DWRs("ApproachOrganNotPronounced")
            'txtLink(2) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralorganApproachID_=_16_AND_ReferralOrganAppropriateID_=_1_"
            'txtRow(3) = intCalcPercentage(DWRs("ApproachBoneNotPronounced"), pvTotals(7))
            'txtRow(4) = DWRs("ApproachBoneNotPronounced")
            'txtLink(4) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralBoneApproachID_=_16_AND_ReferralBoneAppropriateID_=_1_"
            'txtRow(5) = intCalcPercentage(DWRs("ApproachTissueNotPronounced"), pvTotals(8))
            'txtRow(6) = DWRs("ApproachTissueNotPronounced")
            'txtLink(6) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralTissueApproachID_=_16_AND_ReferralTissueAppropriateID_=_1_"
            'txtRow(7) = intCalcPercentage(DWRs("ApproachSkinNotPronounced"), pvTotals(9))
            'txtRow(8) = DWRs("ApproachSkinNotPronounced")
            'txtLink(8) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralSkinApproachID_=_16_AND_ReferralSkinAppropriateID_=_1_"
            'txtRow(9) = intCalcPercentage(DWRs("ApproachValvesNotPronounced"), pvTotals(10))
            'txtRow(10) = DWRs("ApproachValvesNotPronounced")
            'txtLink(10) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralValvesApproachID_=_16_AND_ReferralValvesAppropriateID_=_1_"
            'txtRow(11) = intCalcPercentage(DWRs("ApproachEyesNotPronounced"), pvTotals(11))
            'txtRow(12) = DWRs("ApproachEyesNotPronounced")
            'txtLink(12) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralEyesTransApproachID_=_16_AND_ReferralEyesTransAppropriateID_=_1_"
            'Call intPrintRows(txtRow,1,txtLink)

            txtRow(0) = "No Jurisdiction"
            txtRow(1) = intCalcPercentage(DWRs("ApproachOrganNoJurisdiction"), pvTotals(6))
            txtRow(2) = DWRs("ApproachOrganNoJurisdiction")
            txtLink(2) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralorganApproachID_=_17_AND_ReferralOrganAppropriateID_=_1_"
            txtRow(3) = intCalcPercentage(DWRs("ApproachBoneNoJurisdiction"), pvTotals(7))
            txtRow(4) = DWRs("ApproachBoneNoJurisdiction")
            txtLink(4) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralBoneApproachID_=_17_AND_ReferralBoneAppropriateID_=_1_"
            txtRow(5) = intCalcPercentage(DWRs("ApproachTissueNoJurisdiction"), pvTotals(8))
            txtRow(6) = DWRs("ApproachTissueNoJurisdiction")
            txtLink(6) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralTissueApproachID_=_17_AND_ReferralTissueAppropriateID_=_1_"
            txtRow(7) = intCalcPercentage(DWRs("ApproachSkinNoJurisdiction"), pvTotals(9))
            txtRow(8) = DWRs("ApproachSkinNoJurisdiction")
            txtLink(8) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralSkinApproachID_=_17_AND_ReferralSkinAppropriateID_=_1_"
            txtRow(9) = intCalcPercentage(DWRs("ApproachValvesNoJurisdiction"), pvTotals(10))
            txtRow(10) = DWRs("ApproachValvesNoJurisdiction")
            txtLink(10) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralValvesApproachID_=_17_AND_ReferralValvesAppropriateID_=_1_"
            txtRow(11) = intCalcPercentage(DWRs("ApproachEyesNoJurisdiction"), pvTotals(11))
            txtRow(12) = DWRs("ApproachEyesNoJurisdiction")
            txtLink(12) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralEyesTransApproachID_=_17_AND_ReferralEyesTransAppropriateID_=_1_"
            Call intPrintRows(txtRow,1,txtLink)

            txtRow(0) = "Did Not Die"
            txtRow(1) = intCalcPercentage(DWRs("ApproachOrganDidNotDie"), pvTotals(6))
            txtRow(2) = DWRs("ApproachOrganDidNotDie")
            txtLink(2) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralorganApproachID_=_18_AND_ReferralOrganAppropriateID_=_1_"
            txtRow(3) = intCalcPercentage(DWRs("ApproachBoneDidNotDie"), pvTotals(7))
            txtRow(4) = DWRs("ApproachBoneDidNotDie")
            txtLink(4) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralBoneApproachID_=_18_AND_ReferralBoneAppropriateID_=_1_"
            txtRow(5) = intCalcPercentage(DWRs("ApproachTissueDidNotDie"), pvTotals(8))
            txtRow(6) = DWRs("ApproachTissueDidNotDie")
            txtLink(6) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralTissueApproachID_=_18_AND_ReferralTissueAppropriateID_=_1_"
            txtRow(7) = intCalcPercentage(DWRs("ApproachSkinDidNotDie"), pvTotals(9))
            txtRow(8) = DWRs("ApproachSkinDidNotDie")
            txtLink(8) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralSkinApproachID_=_18_AND_ReferralSkinAppropriateID_=_1_"
            txtRow(9) = intCalcPercentage(DWRs("ApproachValvesDidNotDie"), pvTotals(10))
            txtRow(10) = DWRs("ApproachValvesDidNotDie")
            txtLink(10) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralValvesApproachID_=_18_AND_ReferralValvesAppropriateID_=_1_"
            txtRow(11) = intCalcPercentage(DWRs("ApproachEyesDidNotDie"), pvTotals(11))
            txtRow(12) = DWRs("ApproachEyesDidNotDie")
            txtLink(12) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralEyesTransApproachID_=_18_AND_ReferralEyesTransAppropriateID_=_1_"
            Call intPrintRows(txtRow,1,txtLink)

            txtRow(0) = "Hemodiluted"
            txtRow(1) = intCalcPercentage(DWRs("ApproachOrganHemodiluted"), pvTotals(6))
            txtRow(2) = DWRs("ApproachOrganHemodiluted")
            txtLink(2) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralorganApproachID_=_19_AND_ReferralOrganAppropriateID_=_1_"
            txtRow(3) = intCalcPercentage(DWRs("ApproachBoneHemodiluted"), pvTotals(7))
            txtRow(4) = DWRs("ApproachBoneHemodiluted")
            txtLink(4) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralBoneApproachID_=_19_AND_ReferralBoneAppropriateID_=_1_"
            txtRow(5) = intCalcPercentage(DWRs("ApproachTissueHemodiluted"), pvTotals(8))
            txtRow(6) = DWRs("ApproachTissueHemodiluted")
            txtLink(6) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralTissueApproachID_=_19_AND_ReferralTissueAppropriateID_=_1_"
            txtRow(7) = intCalcPercentage(DWRs("ApproachSkinHemodiluted"), pvTotals(9))
            txtRow(8) = DWRs("ApproachSkinHemodiluted")
            txtLink(8) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralSkinApproachID_=_19_AND_ReferralSkinAppropriateID_=_1_"
            txtRow(9) = intCalcPercentage(DWRs("ApproachValvesHemodiluted"), pvTotals(10))
            txtRow(10) = DWRs("ApproachValvesHemodiluted")
            txtLink(10) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralValvesApproachID_=_19_AND_ReferralValvesAppropriateID_=_1_"
            txtRow(11) = intCalcPercentage(DWRs("ApproachEyesHemodiluted"), pvTotals(11))
            txtRow(12) = DWRs("ApproachEyesHemodiluted")
            txtLink(12) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralEyesTransApproachID_=_19_AND_ReferralEyesTransAppropriateID_=_1_"
            Call intPrintRows(txtRow,1,txtLink)

            txtRow(0) = "Team Unavailable"
            txtRow(1) = intCalcPercentage(DWRs("ApproachOrganTeamLogistics"), pvTotals(6))
            txtRow(2) = DWRs("ApproachOrganTeamLogistics")
            txtLink(2) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralorganApproachID_=_20_AND_ReferralOrganAppropriateID_=_1_"
            txtRow(3) = intCalcPercentage(DWRs("ApproachBoneTeamLogistics"), pvTotals(7))
            txtRow(4) = DWRs("ApproachBoneTeamLogistics")
            txtLink(4) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralBoneApproachID_=_20_AND_ReferralBoneAppropriateID_=_1_"
            txtRow(5) = intCalcPercentage(DWRs("ApproachTissueTeamLogistics"), pvTotals(8))
            txtRow(6) = DWRs("ApproachTissueTeamLogistics")
            txtLink(6) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralTissueApproachID_=_20_AND_ReferralTissueAppropriateID_=_1_"
            txtRow(7) = intCalcPercentage(DWRs("ApproachSkinTeamLogistics"), pvTotals(9))
            txtRow(8) = DWRs("ApproachSkinTeamLogistics")
            txtLink(8) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralSkinApproachID_=_20_AND_ReferralSkinAppropriateID_=_1_"
            txtRow(9) = intCalcPercentage(DWRs("ApproachValvesTeamLogistics"), pvTotals(10))
            txtRow(10) = DWRs("ApproachValvesTeamLogistics")
            txtLink(10) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralValvesApproachID_=_20_AND_ReferralValvesAppropriateID_=_1_"
            txtRow(11) = intCalcPercentage(DWRs("ApproachEyesTeamLogistics"), pvTotals(11))
            txtRow(12) = DWRs("ApproachEyesTeamLogistics")
            txtLink(12) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralEyesTransApproachID_=_20_AND_ReferralEyesTransAppropriateID_=_1_"
            Call intPrintRows(txtRow,1,txtLink)

            txtRow(0) = "Consent Retracted"
            txtRow(1) = intCalcPercentage(DWRs("ApproachOrganConsentRetracted"), pvTotals(6))
            txtRow(2) = DWRs("ApproachOrganConsentRetracted")
            txtLink(2) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralorganApproachID_=_21_AND_ReferralOrganAppropriateID_=_1_"
            txtRow(3) = intCalcPercentage(DWRs("ApproachBoneConsentRetracted"), pvTotals(7))
            txtRow(4) = DWRs("ApproachBoneConsentRetracted")
            txtLink(4) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralBoneApproachID_=_21_AND_ReferralBoneAppropriateID_=_1_"
            txtRow(5) = intCalcPercentage(DWRs("ApproachTissueConsentRetracted"), pvTotals(8))
            txtRow(6) = DWRs("ApproachTissueConsentRetracted")
            txtLink(6) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralTissueApproachID_=_21_AND_ReferralTissueAppropriateID_=_1_"
            txtRow(7) = intCalcPercentage(DWRs("ApproachSkinConsentRetracted"), pvTotals(9))
            txtRow(8) = DWRs("ApproachSkinConsentRetracted")
            txtLink(8) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralSkinApproachID_=_21_AND_ReferralSkinAppropriateID_=_1_"
            txtRow(9) = intCalcPercentage(DWRs("ApproachValvesConsentRetracted"), pvTotals(10))
            txtRow(10) = DWRs("ApproachValvesConsentRetracted")
            txtLink(10) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralValvesApproachID_=_21_AND_ReferralValvesAppropriateID_=_1_"
            txtRow(11) = intCalcPercentage(DWRs("ApproachEyesConsentRetracted"), pvTotals(11))
            txtRow(12) = DWRs("ApproachEyesConsentRetracted")
            txtLink(12) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralEyesTransApproachID_=_21_AND_ReferralEyesTransAppropriateID_=_1_"
            Call intPrintRows(txtRow,1,txtLink)

            txtRow(0) = "Declined By Processors"
            txtRow(1) = intCalcPercentage(DWRs("ApproachOrganDeclinedByProcessors"), pvTotals(6))
            txtRow(2) = DWRs("ApproachOrganDeclinedByProcessors")
            txtLink(2) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralorganApproachID_=_22_AND_ReferralOrganAppropriateID_=_1_"
            txtRow(3) = intCalcPercentage(DWRs("ApproachBoneDeclinedByProcessors"), pvTotals(7))
            txtRow(4) = DWRs("ApproachBoneDeclinedByProcessors")
            txtLink(4) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralBoneApproachID_=_22_AND_ReferralBoneAppropriateID_=_1_"
            txtRow(5) = intCalcPercentage(DWRs("ApproachTissueDeclinedByProcessors"), pvTotals(8))
            txtRow(6) = DWRs("ApproachTissueDeclinedByProcessors")
            txtLink(6) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralTissueApproachID_=_22_AND_ReferralTissueAppropriateID_=_1_"
            txtRow(7) = intCalcPercentage(DWRs("ApproachSkinDeclinedByProcessors"), pvTotals(9))
            txtRow(8) = DWRs("ApproachSkinDeclinedByProcessors")
            txtLink(8) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralSkinApproachID_=_22_AND_ReferralSkinAppropriateID_=_1_"
            txtRow(9) = intCalcPercentage(DWRs("ApproachValvesDeclinedByProcessors"), pvTotals(10))
            txtRow(10) = DWRs("ApproachValvesDeclinedByProcessors")
            txtLink(10) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralValvesApproachID_=_22_AND_ReferralValvesAppropriateID_=_1_"
            txtRow(11) = intCalcPercentage(DWRs("ApproachEyesDeclinedByProcessors"), pvTotals(11))
            txtRow(12) = DWRs("ApproachEyesDeclinedByProcessors")
            txtLink(12) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralEyesTransApproachID_=_22_AND_ReferralEyesTransAppropriateID_=_1_"
            Call intPrintRows(txtRow,1,txtLink)
		...
		'response.write(pvStartDate &" ")
		'response.write(pvEndDate &" ")
		'response.write(pvOrgID)
            ...
            'txtRow(0) = "Not Pronounced"
            'txtRow(1) = intCalcPercentage(DWRs("ConsentOrganNotPronounced"), pvTotals(6))
            'txtRow(2) = DWRs("ConsentOrganNotPronounced")
            'txtLink(2) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralOrganConsentID_=_9_AND_ReferralOrganApproachID_=_1_AND_ReferralOrganAppropriateID_=_1_"
            'txtRow(3) = intCalcPercentage(DWRs("ConsentBoneNotPronounced"), pvTotals(7))
            'txtRow(4) = DWRs("ConsentBoneNotPronounced")
            'txtLink(4) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralBoneConsentID_=_9_AND_ReferralBoneApproachID_=_1_AND_ReferralBoneAppropriateID_=_1_"
            'txtRow(5) = intCalcPercentage(DWRs("ConsentTissueNotPronounced"), pvTotals(8))
            'txtRow(6) = DWRs("ConsentTissueNotPronounced")
            'txtLink(6) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralTissueConsentID_=_9_AND_ReferralTissueApproachID_=_1_AND_ReferralTissueAppropriateID_=_1_"
            'txtRow(7) = intCalcPercentage(DWRs("ConsentSkinNotPronounced"), pvTotals(9))
            'txtRow(8) = DWRs("ConsentSkinNotPronounced")
            'txtLink(8) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralSkinConsentID_=_9_AND_ReferralSkinApproachID_=_1_AND_ReferralSkinAppropriateID_=_1_"
            'txtRow(9) = intCalcPercentage(DWRs("ConsentValvesNotPronounced"), pvTotals(10))
            'txtRow(10) = DWRs("ConsentValvesNotPronounced")
            'txtLink(10) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralValvesConsentID_=_9_AND_ReferralValvesApproachID_=_1_AND_ReferralValvesAppropriateID_=_1_"
            'txtRow(11) = intCalcPercentage(DWRs("ConsentEyesNotPronounced"), pvTotals(11))
            'txtRow(12) = DWRs("ConsentEyesNotPronounced")
            'txtLink(12) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralEyesTransConsentID_=_9_AND_ReferralEyesTransApproachID_=_1_AND_ReferralEyesTransAppropriateID_=_1_"
            'Call intPrintRows(txtRow,1,txtLink)

            txtRow(0) = "No Jurisdiction"
            txtRow(1) = intCalcPercentage(DWRs("ConsentOrganNoJurisdiction"), pvTotals(6))
            txtRow(2) = DWRs("ConsentOrganNoJurisdiction")
            txtLink(2) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralOrganConsentID_=_10_AND_ReferralOrganApproachID_=_1_AND_ReferralOrganAppropriateID_=_1_"
            txtRow(3) = intCalcPercentage(DWRs("ConsentBoneNoJurisdiction"), pvTotals(7))
            txtRow(4) = DWRs("ConsentBoneNoJurisdiction")
            txtLink(4) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralBoneConsentID_=_10_AND_ReferralBoneApproachID_=_1_AND_ReferralBoneAppropriateID_=_1_"
            txtRow(5) = intCalcPercentage(DWRs("ConsentTissueNoJurisdiction"), pvTotals(8))
            txtRow(6) = DWRs("ConsentTissueNoJurisdiction")
            txtLink(6) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralTissueConsentID_=_10_AND_ReferralTissueApproachID_=_1_AND_ReferralTissueAppropriateID_=_1_"
            txtRow(7) = intCalcPercentage(DWRs("ConsentSkinNoJurisdiction"), pvTotals(9))
            txtRow(8) = DWRs("ConsentSkinNoJurisdiction")
            txtLink(8) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralSkinConsentID_=_10_AND_ReferralSkinApproachID_=_1_AND_ReferralSkinAppropriateID_=_1_"
            txtRow(9) = intCalcPercentage(DWRs("ConsentValvesNoJurisdiction"), pvTotals(10))
            txtRow(10) = DWRs("ConsentValvesNoJurisdiction")
            txtLink(10) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralValvesConsentID_=_10_AND_ReferralValvesApproachID_=_1_AND_ReferralValvesAppropriateID_=_1_"
            txtRow(11) = intCalcPercentage(DWRs("ConsentEyesNoJurisdiction"), pvTotals(11))
            txtRow(12) = DWRs("ConsentEyesNoJurisdiction")
            txtLink(12) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralEyesTransConsentID_=_10_AND_ReferralEyesTransApproachID_=_1_AND_ReferralEyesTransAppropriateID_=_1_"
            Call intPrintRows(txtRow,1,txtLink)

            txtRow(0) = "Did Not Die"
            txtRow(1) = intCalcPercentage(DWRs("ConsentOrganDidNotDie"), pvTotals(6))
            txtRow(2) = DWRs("ConsentOrganDidNotDie")
            txtLink(2) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralOrganConsentID_=_11_AND_ReferralOrganApproachID_=_1_AND_ReferralOrganAppropriateID_=_1_"
            txtRow(3) = intCalcPercentage(DWRs("ConsentBoneDidNotDie"), pvTotals(7))
            txtRow(4) = DWRs("ConsentBoneDidNotDie")
            txtLink(4) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralBoneConsentID_=_11_AND_ReferralBoneApproachID_=_1_AND_ReferralBoneAppropriateID_=_1_"
            txtRow(5) = intCalcPercentage(DWRs("ConsentTissueDidNotDie"), pvTotals(8))
            txtRow(6) = DWRs("ConsentTissueDidNotDie")
            txtLink(6) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralTissueConsentID_=_11_AND_ReferralTissueApproachID_=_1_AND_ReferralTissueAppropriateID_=_1_"
            txtRow(7) = intCalcPercentage(DWRs("ConsentSkinDidNotDie"), pvTotals(9))
            txtRow(8) = DWRs("ConsentSkinDidNotDie")
            txtLink(8) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralSkinConsentID_=_11_AND_ReferralSkinApproachID_=_1_AND_ReferralSkinAppropriateID_=_1_"
            txtRow(9) = intCalcPercentage(DWRs("ConsentValvesDidNotDie"), pvTotals(10))
            txtRow(10) = DWRs("ConsentValvesDidNotDie")
            txtLink(10) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralValvesConsentID_=_11_AND_ReferralValvesApproachID_=_1_AND_ReferralValvesAppropriateID_=_1_"
            txtRow(11) = intCalcPercentage(DWRs("ConsentEyesDidNotDie"), pvTotals(11))
            txtRow(12) = DWRs("ConsentEyesDidNotDie")
            txtLink(12) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralEyesTransConsentID_=_11_AND_ReferralEyesTransApproachID_=_1_AND_ReferralEyesTransAppropriateID_=_1_"
            Call intPrintRows(txtRow,1,txtLink)
            ...
            'ccarroll 11/21/2006 added options StatTrac 8.2
            'txtRow(0) = "Not Pronounced"
            'txtRow(1) = intCalcPercentage(DWRs("ConversionOrganNotPronounced"), pvTotals(6))
            'txtRow(2) = DWRs("ConversionOrganNotPronounced")
            'txtLink(2) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralOrganConversionID_=_12_AND_ReferralOrganConsentID_=_1_AND_ReferralOrganApproachID_=_1_AND_ReferralOrganAppropriateID_=_1_"
            'txtRow(3) = intCalcPercentage(DWRs("ConversionBoneNotPronounced"), pvTotals(7))
            'txtRow(4) = DWRs("ConversionBoneNotPronounced")
            'txtLink(4) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralBoneConversionID_=_12_AND_ReferralBoneConsentID_=_1_AND_ReferralBoneApproachID_=_1_AND_ReferralBoneAppropriateID_=_1_"
            'txtRow(5) = intCalcPercentage(DWRs("ConversionTissueNotPronounced"), pvTotals(8))
            'txtRow(6) = DWRs("ConversionTissueNotPronounced")
            'txtLink(6) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralTissueConversionID_=_12_AND_ReferralTissueConsentID_=_1_AND_ReferralTissueApproachID_=_1_AND_ReferralTissueAppropriateID_=_1_"
            'txtRow(7) = intCalcPercentage(DWRs("ConversionSkinNotPronounced"), pvTotals(9))
            'txtRow(8) = DWRs("ConversionSkinNotPronounced")
            'txtLink(8) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralSkinConversionID_=_12_AND_ReferralSkinConsentID_=_1_AND_ReferralSkinApproachID_=_1_AND_ReferralSkinAppropriateID_=_1_"
            'txtRow(9) = intCalcPercentage(DWRs("ConversionValvesNotPronounced"), pvTotals(10))
            'txtRow(10) = DWRs("ConversionValvesNotPronounced")
            'txtLink(10) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralValvesConversionID_=_12_AND_ReferralValvesConsentID_=_1_AND_ReferralValvesApproachID_=_1_AND_ReferralValvesAppropriateID_=_1_"
            'txtRow(11) = intCalcPercentage(DWRs("ConversionEyesNotPronounced"), pvTotals(11))
            'txtRow(12) = DWRs("ConversionEyesNotPronounced")
            'txtLink(12) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralEyesTransConversionID_=_12_AND_ReferralEyesTransConsentID_=_1_AND_ReferralEyesTransApproachID_=_1_AND_ReferralEyesTransAppropriateID_=_1_"
            'Call intPrintRows(txtRow,1,txtLink)

            txtRow(0) = "No Jurisdiction"
            txtRow(1) = intCalcPercentage(DWRs("ConversionOrganNoJurisdiction"), pvTotals(6))
            txtRow(2) = DWRs("ConversionOrganNoJurisdiction")
            txtLink(2) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralOrganConversionID_=_13_AND_ReferralOrganConsentID_=_1_AND_ReferralOrganApproachID_=_1_AND_ReferralOrganAppropriateID_=_1_"
            txtRow(3) = intCalcPercentage(DWRs("ConversionBoneNoJurisdiction"), pvTotals(7))
            txtRow(4) = DWRs("ConversionBoneNoJurisdiction")
            txtLink(4) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralBoneConversionID_=_13_AND_ReferralBoneConsentID_=_1_AND_ReferralBoneApproachID_=_1_AND_ReferralBoneAppropriateID_=_1_"
            txtRow(5) = intCalcPercentage(DWRs("ConversionTissueNoJurisdiction"), pvTotals(8))
            txtRow(6) = DWRs("ConversionTissueNoJurisdiction")
            txtLink(6) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralTissueConversionID_=_13_AND_ReferralTissueConsentID_=_1_AND_ReferralTissueApproachID_=_1_AND_ReferralTissueAppropriateID_=_1_"
            txtRow(7) = intCalcPercentage(DWRs("ConversionSkinNoJurisdiction"), pvTotals(9))
            txtRow(8) = DWRs("ConversionSkinNoJurisdiction")
            txtLink(8) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralSkinConversionID_=_13_AND_ReferralSkinConsentID_=_1_AND_ReferralSkinApproachID_=_1_AND_ReferralSkinAppropriateID_=_1_"
            txtRow(9) = intCalcPercentage(DWRs("ConversionValvesNoJurisdiction"), pvTotals(10))
            txtRow(10) = DWRs("ConversionValvesNoJurisdiction")
            txtLink(10) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralValvesConversionID_=_13_AND_ReferralValvesConsentID_=_1_AND_ReferralValvesApproachID_=_1_AND_ReferralValvesAppropriateID_=_1_"
            txtRow(11) = intCalcPercentage(DWRs("ConversionEyesNoJurisdiction"), pvTotals(11))
            txtRow(12) = DWRs("ConversionEyesNoJurisdiction")
            txtLink(12) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralEyesTransConversionID_=_13_AND_ReferralEyesTransConsentID_=_1_AND_ReferralEyesTransApproachID_=_1_AND_ReferralEyesTransAppropriateID_=_1_"
            Call intPrintRows(txtRow,1,txtLink)

            txtRow(0) = "Did Not Die"
            txtRow(1) = intCalcPercentage(DWRs("ConversionOrganDidNotDie"), pvTotals(6))
            txtRow(2) = DWRs("ConversionOrganDidNotDie")
            txtLink(2) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralOrganConversionID_=_14_AND_ReferralOrganConsentID_=_1_AND_ReferralOrganApproachID_=_1_AND_ReferralOrganAppropriateID_=_1_"
            txtRow(3) = intCalcPercentage(DWRs("ConversionBoneDidNotDie"), pvTotals(7))
            txtRow(4) = DWRs("ConversionBoneDidNotDie")
            txtLink(4) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralBoneConversionID_=_14_AND_ReferralBoneConsentID_=_1_AND_ReferralBoneApproachID_=_1_AND_ReferralBoneAppropriateID_=_1_"
            txtRow(5) = intCalcPercentage(DWRs("ConversionTissueDidNotDie"), pvTotals(8))
            txtRow(6) = DWRs("ConversionTissueDidNotDie")
            txtLink(6) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralTissueConversionID_=_14_AND_ReferralTissueConsentID_=_1_AND_ReferralTissueApproachID_=_1_AND_ReferralTissueAppropriateID_=_1_"
            txtRow(7) = intCalcPercentage(DWRs("ConversionSkinDidNotDie"), pvTotals(9))
            txtRow(8) = DWRs("ConversionSkinDidNotDie")
            txtLink(8) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralSkinConversionID_=_14_AND_ReferralSkinConsentID_=_1_AND_ReferralSkinApproachID_=_1_AND_ReferralSkinAppropriateID_=_1_"
            txtRow(9) = intCalcPercentage(DWRs("ConversionValvesDidNotDie"), pvTotals(10))
            txtRow(10) = DWRs("ConversionValvesDidNotDie")
            txtLink(10) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralValvesConversionID_=_14_AND_ReferralValvesConsentID_=_1_AND_ReferralValvesApproachID_=_1_AND_ReferralValvesAppropriateID_=_1_"
            txtRow(11) = intCalcPercentage(DWRs("ConversionEyesDidNotDie"), pvTotals(11))
            txtRow(12) = DWRs("ConversionEyesDidNotDie")
            txtLink(12) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralEyesTransConversionID_=_14_AND_ReferralEyesTransConsentID_=_1_AND_ReferralEyesTransApproachID_=_1_AND_ReferralEyesTransAppropriateID_=_1_"
            Call intPrintRows(txtRow,1,txtLink)

            txtRow(0) = "Hemodiluted"
            txtRow(1) = intCalcPercentage(DWRs("ConversionOrganHemodiluted"), pvTotals(6))
            txtRow(2) = DWRs("ConversionOrganHemodiluted")
            txtLink(2) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralOrganConversionID_=_15_AND_ReferralOrganConsentID_=_1_AND_ReferralOrganApproachID_=_1_AND_ReferralOrganAppropriateID_=_1_"
            txtRow(3) = intCalcPercentage(DWRs("ConversionBoneHemodiluted"), pvTotals(7))
            txtRow(4) = DWRs("ConversionBoneHemodiluted")
            txtLink(4) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralBoneConversionID_=_15_AND_ReferralBoneConsentID_=_1_AND_ReferralBoneApproachID_=_1_AND_ReferralBoneAppropriateID_=_1_"
            txtRow(5) = intCalcPercentage(DWRs("ConversionTissueHemodiluted"), pvTotals(8))
            txtRow(6) = DWRs("ConversionTissueHemodiluted")
            txtLink(6) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralTissueConversionID_=_15_AND_ReferralTissueConsentID_=_1_AND_ReferralTissueApproachID_=_1_AND_ReferralTissueAppropriateID_=_1_"
            txtRow(7) = intCalcPercentage(DWRs("ConversionSkinHemodiluted"), pvTotals(9))
            txtRow(8) = DWRs("ConversionSkinHemodiluted")
            txtLink(8) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralSkinConversionID_=_15_AND_ReferralSkinConsentID_=_1_AND_ReferralSkinApproachID_=_1_AND_ReferralSkinAppropriateID_=_1_"
            txtRow(9) = intCalcPercentage(DWRs("ConversionValvesHemodiluted"), pvTotals(10))
            txtRow(10) = DWRs("ConversionValvesHemodiluted")
            txtLink(10) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralValvesConversionID_=_15_AND_ReferralValvesConsentID_=_1_AND_ReferralValvesApproachID_=_1_AND_ReferralValvesAppropriateID_=_1_"
            txtRow(11) = intCalcPercentage(DWRs("ConversionEyesHemodiluted"), pvTotals(11))
            txtRow(12) = DWRs("ConversionEyesHemodiluted")
            txtLink(12) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralEyesTransConversionID_=_15_AND_ReferralEyesTransConsentID_=_1_AND_ReferralEyesTransApproachID_=_1_AND_ReferralEyesTransAppropriateID_=_1_"
            Call intPrintRows(txtRow,1,txtLink)

            txtRow(0) = "Team Unavailable"
            txtRow(1) = intCalcPercentage(DWRs("ConversionOrganTeamLogistics"), pvTotals(6))
            txtRow(2) = DWRs("ConversionOrganTeamLogistics")
            txtLink(2) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralOrganConversionID_=_16_AND_ReferralOrganConsentID_=_1_AND_ReferralOrganApproachID_=_1_AND_ReferralOrganAppropriateID_=_1_"
            txtRow(3) = intCalcPercentage(DWRs("ConversionBoneTeamLogistics"), pvTotals(7))
            txtRow(4) = DWRs("ConversionBoneTeamLogistics")
            txtLink(4) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralBoneConversionID_=_16_AND_ReferralBoneConsentID_=_1_AND_ReferralBoneApproachID_=_1_AND_ReferralBoneAppropriateID_=_1_"
            txtRow(5) = intCalcPercentage(DWRs("ConversionTissueTeamLogistics"), pvTotals(8))
            txtRow(6) = DWRs("ConversionTissueTeamLogistics")
            txtLink(6) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralTissueConversionID_=_16_AND_ReferralTissueConsentID_=_1_AND_ReferralTissueApproachID_=_1_AND_ReferralTissueAppropriateID_=_1_"
            txtRow(7) = intCalcPercentage(DWRs("ConversionSkinTeamLogistics"), pvTotals(9))
            txtRow(8) = DWRs("ConversionSkinTeamLogistics")
            txtLink(8) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralSkinConversionID_=_16_AND_ReferralSkinConsentID_=_1_AND_ReferralSkinApproachID_=_1_AND_ReferralSkinAppropriateID_=_1_"
            txtRow(9) = intCalcPercentage(DWRs("ConversionValvesTeamLogistics"), pvTotals(10))
            txtRow(10) = DWRs("ConversionValvesTeamLogistics")
            txtLink(10) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralValvesConversionID_=_16_AND_ReferralValvesConsentID_=_1_AND_ReferralValvesApproachID_=_1_AND_ReferralValvesAppropriateID_=_1_"
            txtRow(11) = intCalcPercentage(DWRs("ConversionEyesTeamLogistics"), pvTotals(11))
            txtRow(12) = DWRs("ConversionEyesTeamLogistics")
            txtLink(12) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralEyesTransConversionID_=_16_AND_ReferralEyesTransConsentID_=_1_AND_ReferralEyesTransApproachID_=_1_AND_ReferralEyesTransAppropriateID_=_1_"
            Call intPrintRows(txtRow,1,txtLink)

            txtRow(0) = "Consent Retracted"
            txtRow(1) = intCalcPercentage(DWRs("ConversionOrganConsentRetracted"), pvTotals(6))
            txtRow(2) = DWRs("ConversionOrganConsentRetracted")
            txtLink(2) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralOrganConversionID_=_17_AND_ReferralOrganConsentID_=_1_AND_ReferralOrganApproachID_=_1_AND_ReferralOrganAppropriateID_=_1_"
            txtRow(3) = intCalcPercentage(DWRs("ConversionBoneConsentRetracted"), pvTotals(7))
            txtRow(4) = DWRs("ConversionBoneConsentRetracted")
            txtLink(4) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralBoneConversionID_=_17_AND_ReferralBoneConsentID_=_1_AND_ReferralBoneApproachID_=_1_AND_ReferralBoneAppropriateID_=_1_"
            txtRow(5) = intCalcPercentage(DWRs("ConversionTissueConsentRetracted"), pvTotals(8))
            txtRow(6) = DWRs("ConversionTissueConsentRetracted")
            txtLink(6) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralTissueConversionID_=_17_AND_ReferralTissueConsentID_=_1_AND_ReferralTissueApproachID_=_1_AND_ReferralTissueAppropriateID_=_1_"
            txtRow(7) = intCalcPercentage(DWRs("ConversionSkinConsentRetracted"), pvTotals(9))
            txtRow(8) = DWRs("ConversionSkinConsentRetracted")
            txtLink(8) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralSkinConversionID_=_17_AND_ReferralSkinConsentID_=_1_AND_ReferralSkinApproachID_=_1_AND_ReferralSkinAppropriateID_=_1_"
            txtRow(9) = intCalcPercentage(DWRs("ConversionValvesConsentRetracted"), pvTotals(10))
            txtRow(10) = DWRs("ConversionValvesConsentRetracted")
            txtLink(10) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralValvesConversionID_=_17_AND_ReferralValvesConsentID_=_1_AND_ReferralValvesApproachID_=_1_AND_ReferralValvesAppropriateID_=_1_"
            txtRow(11) = intCalcPercentage(DWRs("ConversionEyesConsentRetracted"), pvTotals(11))
            txtRow(12) = DWRs("ConversionEyesConsentRetracted")
            txtLink(12) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralEyesTransConversionID_=_17_AND_ReferralEyesTransConsentID_=_1_AND_ReferralEyesTransApproachID_=_1_AND_ReferralEyesTransAppropriateID_=_1_"
            Call intPrintRows(txtRow,1,txtLink)

            txtRow(0) = "Declined By Processors"
            txtRow(1) = intCalcPercentage(DWRs("ConversionOrganDeclinedByProcessors"), pvTotals(6))
            txtRow(2) = DWRs("ConversionOrganDeclinedByProcessors")
            txtLink(2) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralOrganConversionID_=_18_AND_ReferralOrganConsentID_=_1_AND_ReferralOrganApproachID_=_1_AND_ReferralOrganAppropriateID_=_1_"
            txtRow(3) = intCalcPercentage(DWRs("ConversionBoneDeclinedByProcessors"), pvTotals(7))
            txtRow(4) = DWRs("ConversionBoneDeclinedByProcessors")
            txtLink(4) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralBoneConversionID_=_18_AND_ReferralBoneConsentID_=_1_AND_ReferralBoneApproachID_=_1_AND_ReferralBoneAppropriateID_=_1_"
            txtRow(5) = intCalcPercentage(DWRs("ConversionTissueDeclinedByProcessors"), pvTotals(8))
            txtRow(6) = DWRs("ConversionTissueDeclinedByProcessors")
            txtLink(6) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralTissueConversionID_=_18_AND_ReferralTissueConsentID_=_1_AND_ReferralTissueApproachID_=_1_AND_ReferralTissueAppropriateID_=_1_"
            txtRow(7) = intCalcPercentage(DWRs("ConversionSkinDeclinedByProcessors"), pvTotals(9))
            txtRow(8) = DWRs("ConversionSkinDeclinedByProcessors")
            txtLink(8) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralSkinConversionID_=_18_AND_ReferralSkinConsentID_=_1_AND_ReferralSkinApproachID_=_1_AND_ReferralSkinAppropriateID_=_1_"
            txtRow(9) = intCalcPercentage(DWRs("ConversionValvesDeclinedByProcessors"), pvTotals(10))
            txtRow(10) = DWRs("ConversionValvesDeclinedByProcessors")
            txtLink(10) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralValvesConversionID_=_18_AND_ReferralValvesConsentID_=_1_AND_ReferralValvesApproachID_=_1_AND_ReferralValvesAppropriateID_=_1_"
            txtRow(11) = intCalcPercentage(DWRs("ConversionEyesDeclinedByProcessors"), pvTotals(11))
            txtRow(12) = DWRs("ConversionEyesDeclinedByProcessors")
            txtLink(12) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralEyesTransConversionID_=_18_AND_ReferralEyesTransConsentID_=_1_AND_ReferralEyesTransApproachID_=_1_AND_ReferralEyesTransAppropriateID_=_1_"
            Call intPrintRows(txtRow,1,txtLink)

            txtRow(0) = "Unapproachable"
            txtRow(1) = intCalcPercentage(DWRs("ConversionOrganUnapproachable"), pvTotals(6))
            txtRow(2) = DWRs("ConversionOrganUnapproachable")
            txtLink(2) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralOrganConversionID_=_19_AND_ReferralOrganConsentID_=_1_AND_ReferralOrganApproachID_=_1_AND_ReferralOrganAppropriateID_=_1_"
            txtRow(3) = intCalcPercentage(DWRs("ConversionBoneUnapproachable"), pvTotals(7))
            txtRow(4) = DWRs("ConversionBoneUnapproachable")
            txtLink(4) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralBoneConversionID_=_19_AND_ReferralBoneConsentID_=_1_AND_ReferralBoneApproachID_=_1_AND_ReferralBoneAppropriateID_=_1_"
            txtRow(5) = intCalcPercentage(DWRs("ConversionTissueUnapproachable"), pvTotals(8))
            txtRow(6) = DWRs("ConversionTissueUnapproachable")
            txtLink(6) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralTissueConversionID_=_19_AND_ReferralTissueConsentID_=_1_AND_ReferralTissueApproachID_=_1_AND_ReferralTissueAppropriateID_=_1_"
            txtRow(7) = intCalcPercentage(DWRs("ConversionSkinUnapproachable"), pvTotals(9))
            txtRow(8) = DWRs("ConversionSkinUnapproachable")
            txtLink(8) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralSkinConversionID_=_19_AND_ReferralSkinConsentID_=_1_AND_ReferralSkinApproachID_=_1_AND_ReferralSkinAppropriateID_=_1_"
            txtRow(9) = intCalcPercentage(DWRs("ConversionValvesUnapproachable"), pvTotals(10))
            txtRow(10) = DWRs("ConversionValvesUnapproachable")
            txtLink(10) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralValvesConversionID_=_19_AND_ReferralValvesConsentID_=_1_AND_ReferralValvesApproachID_=_1_AND_ReferralValvesAppropriateID_=_1_"
            txtRow(11) = intCalcPercentage(DWRs("ConversionEyesUnapproachable"), pvTotals(11))
            txtRow(12) = DWRs("ConversionEyesUnapproachable")
            txtLink(12) = "&Options=&ReportID=9&NoLog=1&And=AND_ReferralEyesTransConversionID_=_19_AND_ReferralEyesTransConsentID_=_1_AND_ReferralEyesTransApproachID_=_1_AND_ReferralEyesTransAppropriateID_=_1_"
            Call intPrintRows(txtRow,1,txtLink)
