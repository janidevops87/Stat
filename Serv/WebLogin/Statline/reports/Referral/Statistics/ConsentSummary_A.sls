...
If AuthorizeMain Then
	...
	Select Case pvType
		Case 0
			vMainTitle = "Consent Summary (All Types)"
		Case 1
			vMainTitle = "Consent Summary (Organs Only)"
		Case 2
			vMainTitle = "Consent Summary (Tissue Only)"
		Case 3
			vMainTitle = "Consent Summary (Eyes Only)"
	End Select 	
...
%>
		<TR>
			...
			<TD <%=vCurrentColor%> ALIGN=Left><FONT SIZE="1" FACE="<%=FontNameHead%>"><%=RS(vTypePrefix & "TotalApproached")%></FONT></TD>
			<%vTotals(1) = vTotals(1) + RS(vTypePrefix & "TotalApproached")%>
						
			<%
			vTotals(4) = vTotals(4) + RS(vTypePrefix & "TotalConsented")			
			%>
			<TD width="4%" <%=vCurrentColor%>><FONT SIZE="1" FACE="<%=FontNameHead%>"><%=RS(vTypePrefix & "TotalConsented")%></FONT></TD>
			<%If RS(vTypePrefix & "TotalApproached") = 0 Then%>
				<TD width="9%" <%=vCurrentColor%>><I><FONT SIZE="1" FACE="<%=FontNameHead%>">0%</FONT></I></TD>			
			<%Else%>			
				<TD width="9%" <%=vCurrentColor%>><I><FONT SIZE="1" FACE="<%=FontNameHead%>"><%=FormatNumber((RS(vTypePrefix & "TotalConsented")/RS(vTypePrefix & "TotalApproached"))*100,0)%>%</FONT></I></TD>
			<%End If%>
									
	<!-- Detail -->
			<%
			vTotals(2) = vTotals(2) + RS(vTypePrefix & "Approach_DR")
			%>			
			<TD width="4%" <%=vCurrentColor%>><FONT SIZE="1" FACE="<%=FontNameHead%>"><%=RS(vTypePrefix & "Approach_DR")%></FONT></TD>
			<%If RS(vTypePrefix & "TotalApproached") = 0 Then%>
				<TD width="7%" <%=vCurrentColor%>><I><FONT SIZE="1" FACE="<%=FontNameHead%>">0%</FONT></I></TD>			
			<%Else%>
				<TD width="7%" <%=vCurrentColor%>><I><FONT SIZE="1" FACE="<%=FontNameHead%>"><%=FormatNumber((RS(vTypePrefix & "Approach_DR")/RS(vTypePrefix & "TotalApproached"))*100,0)%>%</FONT></I></TD>
			<%End If%>
				
			<%
			vTotals(5) = vTotals(5) + RS(vTypePrefix & "Consent_DR")			
			%>
			<TD width="4%" <%=vCurrentColor%>><FONT SIZE="1" FACE="<%=FontNameHead%>"><%=RS(vTypePrefix & "Consent_DR")%></FONT></TD>
			<%If RS(vTypePrefix & "Approach_DR") = 0 Then%>
				<TD width="9%" <%=vCurrentColor%>><I><FONT SIZE="1" FACE="<%=FontNameHead%>">0%</FONT></I></TD>			
			<%Else%>			
				<TD width="9%" <%=vCurrentColor%>><I><FONT SIZE="1" FACE="<%=FontNameHead%>"><%=FormatNumber((RS(vTypePrefix & "Consent_DR")/RS(vTypePrefix & "Approach_DR"))*100,0)%>%</FONT></I></TD>
			<%End If%>
							
			<%
			vTotals(3) = vTotals(3) + RS(vTypePrefix & "Approach_NonDR")
			%>			
			<TD width="4%" <%=vCurrentColor%>><FONT SIZE="1" FACE="<%=FontNameHead%>"><%=RS(vTypePrefix & "Approach_NonDR")%></FONT></TD>
			<%If RS(vTypePrefix & "TotalApproached") = 0 Then%>
				<TD width="7%" <%=vCurrentColor%>><I><FONT SIZE="1" FACE="<%=FontNameHead%>">0%</FONT></I></TD>			
			<%Else%>
				<TD width="7%" <%=vCurrentColor%>><I><FONT SIZE="1" FACE="<%=FontNameHead%>"><%=FormatNumber((RS(vTypePrefix & "Approach_NonDR")/RS(vTypePrefix & "TotalApproached"))*100,0)%>%</FONT></I></TD>
			<%End If%>

			<%
			vTotals(6) = vTotals(6) + RS(vTypePrefix & "Consent_NonDR")			
			%>
			<TD width="4%" <%=vCurrentColor%>><FONT SIZE="1" FACE="<%=FontNameHead%>"><%=RS(vTypePrefix & "Consent_NonDR")%></FONT></TD>
			<%If RS(vTypePrefix & "Approach_NonDR") = 0 Then%>
				<TD width="3%" <%=vCurrentColor%>><I><FONT SIZE="1" FACE="<%=FontNameHead%>">0%</FONT></I></TD>			
			<%Else%>		
				<TD width="3%" <%=vCurrentColor%>><I><FONT SIZE="1" FACE="<%=FontNameHead%>"><%=FormatNumber((RS(vTypePrefix & "Consent_NonDR")/RS(vTypePrefix & "Approach_NonDR"))*100,0)%>%</FONT></I></TD>
			<%End If%>
	...
	<TR><TD><FONT SIZE="1" FACE="<%=FontNameHead%>"><B>Totals</B></TD>
		...
		<!-- Totals -->
		<TD width="4%"><FONT SIZE="1" FACE="<%=FontNameHead%>"><B><%=vTotals(2)%></B></FONT></TD>
		<%If vTotals(1) = 0 Then%>
			<TD width="7%"><I><FONT SIZE="1" FACE="<%=FontNameHead%>"><B>0%</B></FONT></I></TD>			
		<%Else%>		
			<TD width="7%"><FONT SIZE="1" FACE="<%=FontNameHead%>"><B><I><%=FormatNumber((vTotals(2)/vTotals(1))*100,0)%>%</B></I></FONT></TD>		
		<%End If%>
		...
		<%Else%>			
			<TD width="10%"><FONT SIZE="1" FACE="<%=FontNameHead%>"><B><I><%=FormatNumber((vTotals(5)/vTotals(2))*100,0)%>%</B></I></FONT></TD>		
		<%End If%>
				
		<TD width="4%"><FONT SIZE="1" FACE="<%=FontNameHead%>"><B><%=vTotals(3)%></B></FONT></TD>
		<%If vTotals(1) = 0 Then%>
			<TD width="7%"><I><FONT SIZE="1" FACE="<%=FontNameHead%>"><B>0%</B></FONT></I></TD>			
		<%Else%>		
			<TD width="7%"><FONT SIZE="1" FACE="<%=FontNameHead%>"><B><I><%=FormatNumber((vTotals(3)/vTotals(1))*100,0)%>%</B></I></FONT></TD>		
		<%End If%>
		
		<TD width="4%"><FONT SIZE="1" FACE="<%=FontNameHead%>"><B><%=vTotals(6)%></B></FONT></TD>
		<%If vTotals(3) = 0 Then%>
			<TD width="5%"><I><FONT SIZE="1" FACE="<%=FontNameHead%>"><B>0%</B></FONT></I></TD>			
		<%Else%>			
			<TD width="5%"><FONT SIZE="1" FACE="<%=FontNameHead%>"><B><I><%=FormatNumber((vTotals(6)/vTotals(3))*100,0)%>%</B></I></FONT></TD>		
		<%End If%>
