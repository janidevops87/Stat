...
<%End If %>
	...
	<% 
		...
		For y = 0 to 15 
		IF ResultArray(105 + y,i)<> "" Then 
	%>
		  <tr valign="TOP">
			<td width="35%" valign="TOP"><table border="0" width="100%" rules="All">
			  <tr valign="TOP" >
				<td width="40%" valign="TOP"><b><font size="<%=FontSizeHeadLog%>" face="<%=FontNameHeadLog%>"><%=ResultArray(105+y, i) & ":"%> </font></b></td>
				<td valign="TOP"><font size="<%=FontSizeDataLog%>" face="<%=FontNameDataLog%>"><%=ResultArray(89+y,i)%></font></td>
			  </tr>
			</table>
			</td>
		  </tr>
