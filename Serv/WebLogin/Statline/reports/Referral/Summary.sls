	...
	'CountCheck = "False"
		If CountCheck = "False" Then
			...
			If ExecuteMain Then%>
				...
				<!--#include virtual="/loginstatline/reports/referral/SummaryDetail.sls"-->
...
Function ExecuteMain()
	...
	ErrorReturn = Referral.GetSummary(ResultArray, vTZ, pvCallID, pvStartDate, pvEndDate, pvReportGroupID, pvOrgID, pvReferralTypeID, pvAnd, pvOrderBy, pvUserOrgID, DataSourceName)
