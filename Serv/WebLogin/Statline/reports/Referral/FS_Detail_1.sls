...
<!--#include virtual="/loginstatline/includes/QueryReferralDetail_fs.sls"-->
<%
' Remove from includes <!--#include virtual="/loginstatline/includes/CountWarning.vbs"-->
...
If AuthorizeMain Then
	...
	If VerifyReferralTypeAccess(True) Then
		...
		CountCheck = "False"  ' Hard coded to False.  10/29/04 - SAP
		...
		If CountCheck = "False" Then
			...
			%>
				<!-- Print the header. -->
				<!--#include file="FS_DetailHead_1.sls"-->
				...
				<%Else
					...
					For i = 0 to Ubound(ResultArray, 2)
						...
						%>
						<!--#include file="FS_Detail_1_1.sls"-->
						<!--#include file="FS_Detail_2_1.sls"-->
						<!--#include file="FS_Detail_3_1.sls"-->
						<!--#include file="FS_Detail_5s_1.sls"-->
            					<!--#include file="FS_Detail_4_1.sls"-->
						
						<!--#include virtual="/loginstatline/includes/copyright.shm"-->
					<%
					
					'T.T 11/7/05: adding flush so Referral Detail can run without timing out or overfilling the buffer
           response.flush
...
<%Function CheckBoxYN(v)
  Select Case v
    Case  0: CheckBoxYN = "No"
    Case  1: CheckBoxYN = "Yes"
    Case Else: CheckBoxYN = "No"
  End Select
End Function%> 
