...
For i = 0 to Ubound(ResultArray,1)
	...
	<table border="0" width="100%" rules="NONE">
	  ...
	  <tr>
		...
		<p><a target="ReferralDetail"
		href="/loginstatline/reports/referral/detail.sls?CallID=<%=ResultArray(i,1)%>&<%=Request.QueryString%>&NoLog=1&CountCheck=False"><%=ResultArray(i,2)%></a>
		</font></td>
