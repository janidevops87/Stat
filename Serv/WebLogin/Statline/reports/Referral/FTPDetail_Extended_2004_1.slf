...
<!--#include virtual="/loginstatline/includes/FTPQueryReferralDetail_Extended_2004.sls"-->
<%
		...
		%>
			...
			Else
				...
				For i = 0 to Ubound(ResultArray, 2)
					...
					vRecord = vRecord & resultarray(181, i)& chr(13) & Chr(10)'181 PronouncingPhysician
