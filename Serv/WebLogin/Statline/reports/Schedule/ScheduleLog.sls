...
If AuthorizeMain Then
	...
	%>
		...
		<!--#include virtual="/loginstatline/reports/schedule/ScheduleLog_ActivitySection.sls"-->
	<%
	Else
	%>
		No Data Available
...
Function ExecuteMain()
	...
	'Get data rows
	vQuery = "sps_GetScheduleLog '" & pvStartDate & "', '" & pvEndDate & "', " & pvScheduleGroupID & ", " & vTZ & ", " & pvUserOrgID & ""
	'Response.Write vQuery
	Set RS = Conn.Execute(vQuery)
