...
If AuthorizeMain Then
	...
	If ExecuteMain Then
		...
		vMainTitle = "Import Offer Activity"
	...
	%>
		...
		<!-- Print the detail. -->
		<!--#include virtual="/loginstatline/reports/import/ActivitySection1.sls"-->
		<!--#include virtual="/loginstatline/reports/import/ActivitySection2.sls"-->
	<%
	Else
	%>
		<FONT SIZE=4 FACE=Arial FONT COLOR = Red><B>No Import Offers</Font>
	<%
	End If
...
Function ExecuteMain()
	...
	'Get data counts
	vQuery = "sps_ImportCount '" & pvStartDate & "', '" & pvEndDate & "', " & UserOrgID & ", " & TZ
	'print vquery
	...
	'Get data rows
	vQuery = "sps_ImportActivity '" & pvStartDate & "', '" & pvEndDate & "', " & UserOrgID & ", " & TZ & ", " & OrderBy
	Set RS = Conn.Execute(vQuery)
