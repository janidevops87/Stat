...
If AuthorizeMain Then
	...
	%>
		<!-- Print the header. -->
		<!--#include virtual="/loginstatline/reports/Import/QA_ActivityHead.sls"-->
					
		<!-- Get the counts of each alert group and referral type. -->
		<!--#include virtual="/loginstatline/reports/import/QA_ActivitySection.sls"-->
	<%
	Else
	%>
		No Data Available
...
Function ExecuteMain()
	...
	'Get data rows
	vQuery = "sps_ImportActivityByAlertGroup '" & pvStartDate & "', '" & pvEndDate & "', " & pvReportGroupID
	''print(vQuery)
	Set RS = Conn.Execute(vQuery)
