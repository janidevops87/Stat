...
<table border="0" width="100%" rules="NONE" frame="VOID">
  <tr>
    ...
    <td width="10%"><b><u><font size="<%=FontSizeHeadLog%>" face="<%=FontNameHeadLog%>">Date/Time</font></td>
    ...
    <td width="12%"><b><u><font size="<%=FontSizeHeadLog%>" face="<%=FontNameHeadLog%>">Event
    Type</font></td>
    <td width="22%"><b><u><font size="<%=FontSizeHeadLog%>" face="<%=FontNameHeadLog%>">Organization</font></td>
    <td width="17%"><b><u><font size="<%=FontSizeHeadLog%>" face="<%=FontNameHeadLog%>">To/From</font></td>
...
<% DateTime = Mid(Section2(0,x),6,2) + "/" + Mid(Section2(0,x),9,2) + "/" + Mid(Section2(0,x),3,2) + " " + Mid(Section2(0,x), 12, 5) %>
  <tr>
    <td valign="TOP"><font size="<%=FontSizeDataLog%>" face="<%=FontNameDataLog%>">
<%
...
%>
    ...
    <td valign="TOP"><font size="<%=FontSizeDataLog%>" face="<%=FontNameDataLog%>"><%=Section2(0,x)%></font></td>
    <%
    'If a Statline user is running the report, then add a column 
    'to display the name of the person who created the log item.
    'If pvUserOrg = 194 Then%>
    ...
    <td valign="TOP"><font size="<%=FontSizeDataLog%>" face="<%=FontNameDataLog%>"><%=Section2(1,x)%></font></td>
    <td valign="TOP"><font size="<%=FontSizeDataLog%>" face="<%=FontNameDataLog%>"><%=Section2(2,x)%></font></td>
    <td valign="TOP"><font size="<%=FontSizeDataLog%>" face="<%=FontNameDataLog%>"><%=Section2(3,x)%></font></td>
    <td valign="TOP"><font size="<%=FontSizeDataLog%>" face="<%=FontNameDataLog%>"><%=Section2(4,x)%></font></td>
  </tr>
<% Next %>
</table>
