...
<!--#include virtual="/loginstatline/includes/FTPQueryReferralDetailReferralNameFix.sls"-->
<%
		...
		%>
			...
			Else
				...
				For i = 0 to Ubound(ResultArray, 2)
					...
					vRecord = vRecord & resultarray(121, i)& Chr(13) & Chr(10) '121 ServiceLevelCustomFieldLabel_16
