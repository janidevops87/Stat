...
vReportName = "Referral Compliance"
%>
...
%>	
	...
	<!--#include virtual="/loginstatline/reports/custom/ReferralComp_Header_CTDN.sls"-->
	...
	<TR>
		...
		<TD ALIGN=Left width="11%"><FONT SIZE="1" FACE="<%=FontNameHead%>"><B>Update</B></TD>
...
%>
		<TR>
			...
			<!-- Detail -->
			<% ' Only add non-negative TotalDeaths numbers.  10/25/04 - SAP
			...
			<% 	vTotals(1) = vTotals(1) + RS("TotalDeaths")
			End If %>
...
<!--#include virtual="/loginstatline/reports/custom/ReferralComp_Footer_CTDN.sls"-->
