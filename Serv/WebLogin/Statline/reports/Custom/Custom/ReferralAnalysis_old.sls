	...
	<%	End If
		...
		If QuitPage = 0 Then
			If pvPageBreak <> 1 Then  ' Display totals, not broken down by Organization, or for a single Organization
				...
				If DWRs("Appropriate" & Replace(pvOrgTypeDbDesc, "Trans", "") & "PreviousVent") = 0 then
					'do nothing
				Else	
				...
				If DWRs("Approach" & Replace(pvOrgTypeDbDesc, "Trans", "") & "Arrest") = 0 then
					'do nothing
				Else
					txtRow(0) = "Arrest"
				...
				If DWRs("Approach" & Replace(pvOrgTypeDbDesc, "Trans", "") & "NeverBrainDead") = 0 then
					'do nothing
				Else
				...
				If DWRs("Approach" & Replace(pvOrgTypeDbDesc, "Trans", "") & "SecondaryRO") = 0 then
					'do nothing
				Else
