		...
		If CountCheck = "False" Then
			...
			%>
				...
				%>
					...
					<!--#include virtual="/loginstatline/reports/custom/NDRIActivitySection2_1.sls"-->
				<%
				End If
...
Function ExecuteMain()
	...
	vQuery = "sps_ReferralActivity_NDRI " & pvReportGroupID & ", '" & pvStartDate &"', " & "'" & pvEndDate &"', " &  pvOrgID & ", " & vTZ &", " & pvReferralTypeID &", " & "'" & pvOrderBy &"', " & pvUserOrgID
