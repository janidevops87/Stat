...
<TR>
	...
	<TR><TD WIDTH="100%">
		...
		<TR>
			<TD ALIGN=LEFT WIDTH="30%"><FONT NAME = "<%=FontNameHead%>" SIZE="<%=FontSizeHead%>"><B>Hold Time (Seconds)</TD></B>
	...
	<P STYLE="line-height: 1pt">&nbsp</P>
		...
		<%ElseIf pvUserOrgID = 194 And vReportGroupID <> 0 Then
			...
			'Get the data
			vQuery = "sps_HoldTimesIncomingReportGp '" & pvStartDate & "', '" & pvEndDate & "', " & vReportGroupID
	...
	<%Else%>
		...
		<TR>
			...
			<TD ALIGN=LEFT WIDTH="30%"><FONT NAME = "<%=FontNameHead%>" SIZE="<%=FontSizeHead%>">
				<a href="/loginstatline/reports/admin/callholddetail2.sls?UserID=<%=Request.QueryString("UserID")%>&amp;ReportGroupID=<%=Request.QueryString("ReportGroupID")%>&amp;UserOrgID=<%=Request.QueryString("UserOrgID")%>&amp;DSN=<%=Request.QueryString("DSN")%>&amp;StartDate=<%=Request.QueryString("StartDate")%>&amp;EndDate=<%=Request.QueryString("EndDate")%>&amp;StartInterval=0&amp;EndInterval=0&amp;vDetailQuery=4"><%=vTotalCalls%></a>
			</TD>
		</TR>
		<TR><TD></TD></TR>
...
<%Sub ExecuteIncoming()%>
	...
	<TR>
		<TD ALIGN=LEFT WIDTH="30%"><FONT NAME = "<%=FontNameData%>" SIZE="<%=FontSizeData%>"> 0 - 30 </TD>
				
		<%If pvUserOrgID = 194 Then%>	
			<TD ALIGN=LEFT WIDTH="30%"><FONT NAME = "<%=FontNameHead%>" SIZE="<%=FontSizeHead%>">
			<a href="/loginstatline/reports/admin/callholddetail.sls?UserID=<%=Request.QueryString("UserID")%>&amp;UserOrgID=<%=Request.QueryString("UserOrgID")%>&amp;DSN=<%=Request.QueryString("DSN")%>&amp;StartDate=<%=Request.QueryString("StartDate")%>&amp;EndDate=<%=Request.QueryString("EndDate")%>&amp;StartInterval=0&amp;EndInterval=.5167&amp;vDetailQuery=0"><%=ROUND(RS("Counts")/vTotalIncomingCalls * 100,1)%></a>
			</TD>
		<%Else%>
		...
		<%If pvUserOrgID = 194 Then%>
			<TD ALIGN=LEFT WIDTH="30%"><FONT NAME = "<%=FontNameHead%>" SIZE="<%=FontSizeHead%>">
			<a href="/loginstatline/reports/admin/callholddetail2.sls?UserID=<%=Request.QueryString("UserID")%>&amp;UserOrgID=<%=Request.QueryString("UserOrgID")%>&amp;DSN=<%=Request.QueryString("DSN")%>&amp;StartDate=<%=Request.QueryString("StartDate")%>&amp;EndDate=<%=Request.QueryString("EndDate")%>&amp;StartInterval=0&amp;EndInterval=.5167&amp;vDetailQuery=0"><%=RS("Counts")%></a>
			</TD>
		<%End If%>		
		<%RS.MoveNext%>
	</TR>
	...
	<TR>
		<TD ALIGN=LEFT WIDTH="30%"><FONT NAME = "<%=FontNameData%>" SIZE="<%=FontSizeData%>"> 31 - 60 </TD>

		<%If pvUserOrgID = 194 Then%>
			<TD ALIGN=LEFT WIDTH="30%"><FONT NAME = "<%=FontNameHead%>" SIZE="<%=FontSizeHead%>">
			<a href="/loginstatline/reports/admin/callholddetail.sls?UserID=<%=Request.QueryString("UserID")%>&amp;UserOrgID=<%=Request.QueryString("UserOrgID")%>&amp;DSN=<%=Request.QueryString("DSN")%>&amp;StartDate=<%=Request.QueryString("StartDate")%>&amp;EndDate=<%=Request.QueryString("EndDate")%>&amp;StartInterval=.5167&amp;EndInterval=1.0167&amp;vDetailQuery=0"><%=ROUND(RS("Counts")/vTotalIncomingCalls * 100,1)%></a>
			</TD>
		<%Else%>
			<TD ALIGN=LEFT WIDTH="30%"><FONT NAME = "<%=FontNameData%>" SIZE="<%=FontSizeData%>"><%=ROUND(RS("Counts")/vTotalIncomingCalls * 100,1)%></TD>
		<%End If%>	
		...
		<%If pvUserOrgID = 194 Then%>
			<TD ALIGN=LEFT WIDTH="30%"><FONT NAME = "<%=FontNameHead%>" SIZE="<%=FontSizeHead%>">
			<a href="/loginstatline/reports/admin/callholddetail2.sls?UserID=<%=Request.QueryString("UserID")%>&amp;UserOrgID=<%=Request.QueryString("UserOrgID")%>&amp;DSN=<%=Request.QueryString("DSN")%>&amp;StartDate=<%=Request.QueryString("StartDate")%>&amp;EndDate=<%=Request.QueryString("EndDate")%>&amp;StartInterval=.5167&amp;EndInterval=1.0167&amp;vDetailQuery=0"><%=RS("Counts")%></a>
			</TD>
		<%End If%>		
		<%RS.MoveNext%>
	</TR>
	...
	<TR>
		...
		<%If pvUserOrgID = 194 Then%>
			<TD ALIGN=LEFT WIDTH="30%"><FONT NAME = "<%=FontNameHead%>" SIZE="<%=FontSizeHead%>">
			<a href="/loginstatline/reports/admin/callholddetail2.sls?UserID=<%=Request.QueryString("UserID")%>&amp;UserOrgID=<%=Request.QueryString("UserOrgID")%>&amp;DSN=<%=Request.QueryString("DSN")%>&amp;StartDate=<%=Request.QueryString("StartDate")%>&amp;EndDate=<%=Request.QueryString("EndDate")%>&amp;StartInterval=1.0167&amp;EndInterval=1.5167&amp;vDetailQuery=0"><%=RS("Counts")%></a>
			</TD>
		<%End If%>		
		<%RS.MoveNext%>
	</TR>
	...
	<TR>
		...
		<%If pvUserOrgID = 194 Then%>
			<TD ALIGN=LEFT WIDTH="30%"><FONT NAME = "<%=FontNameHead%>" SIZE="<%=FontSizeHead%>">
			<a href="/loginstatline/reports/admin/callholddetail2.sls?UserID=<%=Request.QueryString("UserID")%>&amp;UserOrgID=<%=Request.QueryString("UserOrgID")%>&amp;DSN=<%=Request.QueryString("DSN")%>&amp;StartDate=<%=Request.QueryString("StartDate")%>&amp;EndDate=<%=Request.QueryString("EndDate")%>&amp;StartInterval=1.5167&amp;EndInterval=2.0167&amp;vDetailQuery=0"><%=RS("Counts")%></a>
			</TD>
		<%End If%>		
		<%RS.MoveNext%>
	</TR>
	...
	<TR>
		...
		<%If pvUserOrgID = 194 Then%>
			<TD ALIGN=LEFT WIDTH="30%"><FONT NAME = "<%=FontNameHead%>" SIZE="<%=FontSizeHead%>">
			<a href="/loginstatline/reports/admin/callholddetail2.sls?UserID=<%=Request.QueryString("UserID")%>&amp;UserOrgID=<%=Request.QueryString("UserOrgID")%>&amp;DSN=<%=Request.QueryString("DSN")%>&amp;StartDate=<%=Request.QueryString("StartDate")%>&amp;EndDate=<%=Request.QueryString("EndDate")%>&amp;StartInterval=2.0167&amp;EndInterval=60&amp;vDetailQuery=0"><%=RS("Counts")%></a>
			</TD>
		<%End If%>			
	</TR>
	...
	<TR>
		...
		<%If pvUserOrgID = 194 Then%>
			<TD ALIGN=LEFT WIDTH="30%"><FONT NAME = "<%=FontNameHead%>" SIZE="<%=FontSizeHead%>"><B><%=vTotalIncomingCalls%></TD></B>
		<%End If%>
	</TR>
...
<%Sub ExecutePR()%>
	...
	<TR>
		...
		<%If pvUserOrgID = 194 Then%>
			<TD ALIGN=LEFT WIDTH="30%"><FONT NAME = "<%=FontNameHead%>" SIZE="<%=FontSizeHead%>">
			<a href="/loginstatline/reports/admin/callholddetail.sls?UserID=<%=Request.QueryString("UserID")%>&amp;UserOrgID=<%=Request.QueryString("UserOrgID")%>&amp;DSN=<%=Request.QueryString("DSN")%>&amp;StartDate=<%=Request.QueryString("StartDate")%>&amp;EndDate=<%=Request.QueryString("EndDate")%>&amp;StartInterval=0&amp;EndInterval=.5167&amp;vDetailQuery=1"><%=ROUND(RS("Counts")/vTotalPageCalls * 100,1)%></a>
			</TD>
		<%Else%>
		...
		<%If pvUserOrgID = 194 Then%>
			<TD ALIGN=LEFT WIDTH="30%"><FONT NAME = "<%=FontNameHead%>" SIZE="<%=FontSizeHead%>">
			<a href="/loginstatline/reports/admin/callholddetail2.sls?UserID=<%=Request.QueryString("UserID")%>&amp;UserOrgID=<%=Request.QueryString("UserOrgID")%>&amp;DSN=<%=Request.QueryString("DSN")%>&amp;StartDate=<%=Request.QueryString("StartDate")%>&amp;EndDate=<%=Request.QueryString("EndDate")%>&amp;StartInterval=0&amp;EndInterval=.5167&amp;vDetailQuery=1"><%=RS("Counts")%></a>
			</TD>
		<%End If%>	
		<%RS.MoveNext%>
	</TR>
	...
	<TR>
		...
		<%If pvUserOrgID = 194 Then%>
			<TD ALIGN=LEFT WIDTH="30%"><FONT NAME = "<%=FontNameHead%>" SIZE="<%=FontSizeHead%>">
			<a href="/loginstatline/reports/admin/callholddetail2.sls?UserID=<%=Request.QueryString("UserID")%>&amp;UserOrgID=<%=Request.QueryString("UserOrgID")%>&amp;DSN=<%=Request.QueryString("DSN")%>&amp;StartDate=<%=Request.QueryString("StartDate")%>&amp;EndDate=<%=Request.QueryString("EndDate")%>&amp;StartInterval=.5167&amp;EndInterval=1.0167&amp;vDetailQuery=1"><%=RS("Counts")%></a>
			</TD>
		<%End If%>		
		<%RS.MoveNext%>
	</TR>
	...
	<TR>
		...
		<%If pvUserOrgID = 194 Then%>
			<TD ALIGN=LEFT WIDTH="30%"><FONT NAME = "<%=FontNameHead%>" SIZE="<%=FontSizeHead%>">
			<a href="/loginstatline/reports/admin/callholddetail2.sls?UserID=<%=Request.QueryString("UserID")%>&amp;UserOrgID=<%=Request.QueryString("UserOrgID")%>&amp;DSN=<%=Request.QueryString("DSN")%>&amp;StartDate=<%=Request.QueryString("StartDate")%>&amp;EndDate=<%=Request.QueryString("EndDate")%>&amp;StartInterval=1.0167&amp;EndInterval=1.5167&amp;vDetailQuery=1"><%=RS("Counts")%></a>
			</TD>
		<%End If%>			
		<%RS.MoveNext%>
	</TR>
	...
	<TR>
		...
		<%If pvUserOrgID = 194 Then%>
			<TD ALIGN=LEFT WIDTH="30%"><FONT NAME = "<%=FontNameHead%>" SIZE="<%=FontSizeHead%>">
			<a href="/loginstatline/reports/admin/callholddetail2.sls?UserID=<%=Request.QueryString("UserID")%>&amp;UserOrgID=<%=Request.QueryString("UserOrgID")%>&amp;DSN=<%=Request.QueryString("DSN")%>&amp;StartDate=<%=Request.QueryString("StartDate")%>&amp;EndDate=<%=Request.QueryString("EndDate")%>&amp;StartInterval=1.5167&amp;EndInterval=2.0167&amp;vDetailQuery=1"><%=RS("Counts")%></a>
			</TD>
		<%End If%>			
		<%RS.MoveNext%>
	</TR>
	...
	<TR>
		...
		<%If pvUserOrgID = 194 Then%>
			<TD ALIGN=LEFT WIDTH="30%"><FONT NAME = "<%=FontNameHead%>" SIZE="<%=FontSizeHead%>">
			<a href="/loginstatline/reports/admin/callholddetail2.sls?UserID=<%=Request.QueryString("UserID")%>&amp;UserOrgID=<%=Request.QueryString("UserOrgID")%>&amp;DSN=<%=Request.QueryString("DSN")%>&amp;StartDate=<%=Request.QueryString("StartDate")%>&amp;EndDate=<%=Request.QueryString("EndDate")%>&amp;StartInterval=2.0167&amp;EndInterval=60&amp;vDetailQuery=1"><%=RS("Counts")%></a>
			</TD>
		<%End If%>		
	</TR>
...
<%Sub ExecuteIncomingRegional()%>
	...
	<TR>
		...
		<%If pvUserOrgID = 194 Then%>					
			<a href="/loginstatline/reports/admin/callholddetail.sls?UserID=<%=Request.QueryString("UserID")%>&amp;ReportGroupID=<%=Request.QueryString("ReportGroupID")%>&amp;UserOrgID=<%=Request.QueryString("UserOrgID")%>&amp;DSN=<%=Request.QueryString("DSN")%>&amp;StartDate=<%=Request.QueryString("StartDate")%>&amp;EndDate=<%=Request.QueryString("EndDate")%>&amp;StartInterval=0&amp;EndInterval=.5167&amp;vDetailQuery=3"><%=ROUND(RS("Counts")/vTotalRegionalCalls * 100,1)%></a>
		<%Else%>
		...
		<TD ALIGN=LEFT WIDTH="20%"><FONT NAME = "<%=FontNameHead%>" SIZE="<%=FontSizeHead%>">		
		<%If pvUserOrgID <> 194 Then%>		
			<a href="/loginstatline/reports/admin/callholddetail.sls?UserID=<%=Request.QueryString("UserID")%>&amp;ReportGroupID=<%=Request.QueryString("ReportGroupID")%>&amp;UserOrgID=<%=Request.QueryString("UserOrgID")%>&amp;DSN=<%=Request.QueryString("DSN")%>&amp;StartDate=<%=Request.QueryString("StartDate")%>&amp;EndDate=<%=Request.QueryString("EndDate")%>&amp;StartInterval=0&amp;EndInterval=.5167&amp;vDetailQuery=2"><%=RS("Counts")%></a>
		<%Else%>
			<a href="/loginstatline/reports/admin/callholddetail2.sls?UserID=<%=Request.QueryString("UserID")%>&amp;ReportGroupID=<%=Request.QueryString("ReportGroupID")%>&amp;UserOrgID=<%=Request.QueryString("UserOrgID")%>&amp;DSN=<%=Request.QueryString("DSN")%>&amp;StartDate=<%=Request.QueryString("StartDate")%>&amp;EndDate=<%=Request.QueryString("EndDate")%>&amp;StartInterval=0&amp;EndInterval=.5167&amp;vDetailQuery=3"><%=RS("Counts")%></a>
		<%End If%>
		</TD>	
		<%RS.MoveNext%>
	</TR>
	...
	<TR>
		...
		<TD ALIGN=LEFT WIDTH="20%"><FONT NAME = "<%=FontNameHead%>" SIZE="<%=FontSizeHead%>"><B><%=vTotalRegionalCalls%></TD></B>
	</TR>
