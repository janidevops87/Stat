...
%>
	...
	<TR>
		...
		<TD ALIGN=Left  width="30%"><FONT SIZE="1" FACE="<%=FontNameHead%>"><B>&nbsp &nbsp </B></TD>
...
<%
	...
	vQuery = "SPS_FSCSummary_Age" & " '" & pvStartDate & "', '" & pvEndDate & "'"
	'Print(vQuery)
	Set RS = Conn.Execute(vQuery)
	...
	%>
			...
			%>	
						...
						<TD ALIGN=CENTER width="10%" <%=vCurrentColor%>>
							<FONT SIZE="1" FACE="<%=FontNameHead%>">
							<A target="ReferralSummary" HREF="../Referral/summary_A.sls?<%=("Type=2&StartDate=" & Request.QueryString("StartDate") & "&EndDate=" & Request.QueryString("EndDate") & "&ReportGroupID=0&OrgID=0&CallID=-1&userID=" & Request.QueryString("UserID") & "&userOrgID=" & Request.QueryString("UserOrgID") & "&DSN=" & Request.QueryString("DSN") & "&Options=&ReportID=11&NoLog=1&JOIN=_JOIN_FSCase_fsc_ON_fsc.CallID=Call.CallID_JOIN_SecondaryApproach_SA_ON_SA.CallID=Call.CallID_JOIN_Person_AP_ON_AP.PersonID=SA.SecondaryApproachedBy_&AND=_AND_SA.SecondaryApproached=1_AND_AP.OrganizationID=194__AND_SourceCode.SourceCodeID="& RS("SourceCodeID") &"&OrderBy=CALL.CALLID")%>">
							<%=RS("FamilyApproaches")%>
							</A>
							</FONT></TD>
						<!-- <TD ALIGN=CENTER width="10%" <%=vCurrentColor%>>
							<FONT SIZE="1" FACE="<%=FontNameHead%>">
							<A target="ReferralSummary" HREF="../Referral/summary_A.sls?<%=("Type=2&StartDate=" & Request.QueryString("StartDate") & "&EndDate=" & Request.QueryString("EndDate") & "&ReportGroupID=0&OrgID=0&CallID=-1&userID=" & Request.QueryString("UserID") & "&userOrgID=" & Request.QueryString("UserOrgID") & "&DSN=" & Request.QueryString("DSN") & "&Options=&ReportID=11&NoLog=1&JOIN=_JOIN_FSCase_fsc_ON_fsc.CallID=Call.CallID_JOIN_SecondaryApproach_SA_ON_SA.CallID=Call.CallID_JOIN_Person_AP_ON_AP.PersonID=SA.SecondaryApproachedBy_&AND=_AND_SA.SecondaryApproached=2_AND_SA.SecondaryApproachReason=2_AND_AP.OrganizationID=194__AND_SourceCode.SourceCodeID="& RS("SourceCodeID") &"&OrderBy=CALL.CALLID")%>">
						...
						<TD ALIGN=CENTER width="10%" <%=vCurrentColor%>>
							<FONT SIZE="1" FACE="<%=FontNameHead%>">
							<A target="ReferralSummary" HREF="../Referral/summary_A.sls?<%=("Type=2&StartDate=" & Request.QueryString("StartDate") & "&EndDate=" & Request.QueryString("EndDate") & "&ReportGroupID=0&OrgID=0&CallID=-1&userID=" & Request.QueryString("UserID") & "&userOrgID=" & Request.QueryString("UserOrgID") & "&DSN=" & Request.QueryString("DSN") & "&Options=&ReportID=11&NoLog=1&JOIN=_JOIN_FSCase_fsc_ON_fsc.CallID=Call.CallID_JOIN_SecondaryApproach_SA_ON_SA.CallID=Call.CallID_JOIN_Person_AP_ON_AP.PersonID=SA.SecondaryApproachedBy_&AND=_AND_SA.SecondaryApproached=1_AND_((SA.SecondaryApproachOutcome=1_OR_SA.SecondaryApproachOutcome=2)_OR_SA.SecondaryConsentOutcome=1)_AND_AP.OrganizationID=194__AND_SourceCode.SourceCodeID="& RS("SourceCodeID") &"&OrderBy=CALL.CALLID")%>">
							<%=RS("Consent")%>
							</FONT></TD>
						<TD ALIGN=CENTER width="10%" <%=vCurrentColor%>>
							<FONT SIZE="1" FACE="<%=FontNameHead%>">
							<A target="ReferralSummary" HREF="../Referral/summary_A.sls?<%=("Type=2&StartDate=" & Request.QueryString("StartDate") & "&EndDate=" & Request.QueryString("EndDate") & "&ReportGroupID=0&OrgID=0&CallID=-1&userID=" & Request.QueryString("UserID") & "&userOrgID=" & Request.QueryString("UserOrgID") & "&DSN=" & Request.QueryString("DSN") & "&Options=&ReportID=11&NoLog=1&JOIN=_JOIN_FSCase_fsc_ON_fsc.CallID=Call.CallID_JOIN_SecondaryApproach_SA_ON_SA.CallID=Call.CallID_JOIN_Person_AP_ON_AP.PersonID=SA.SecondaryConsentBy_&AND=_AND_SA.SecondaryApproached=1_AND_(SA.SecondaryApproachOutcome=2_OR_SA.SecondaryConsentOutcome=1)_AND_AP.OrganizationID=194__AND_SourceCode.SourceCodeID="& RS("SourceCodeID") &"&OrderBy=CALL.CALLID")%>">
							<%=RS("WrittenConsent")%>
							</A>
							</FONT></TD>
						<TD ALIGN=CENTER width="10%" <%=vCurrentColor%>>
						...
						<TD ALIGN=CENTER width="10%" <%=vCurrentColor%>>
							<FONT SIZE="1" FACE="<%=FontNameHead%>">																																																						
							<A target="ReferralSummary" HREF="../Referral/summary_A.sls?<%=("Type=2&StartDate=" & Request.QueryString("StartDate") & "&EndDate=" & Request.QueryString("EndDate") & "&ReportGroupID=0&OrgID=0&CallID=-1&userID=" & Request.QueryString("UserID") & "&userOrgID=" & Request.QueryString("UserOrgID") & "&DSN=" & Request.QueryString("DSN") & "&Options=&ReportID=11&NoLog=1&JOIN=_JOIN_FSCase_fsc_ON_fsc.CallID=Call.CallID_JOIN_SecondaryApproach_SA_ON_SA.CallID=Call.CallID_LEFT_JOIN_Person_SCP_ON_SCP.PersonID=SA.SecondaryConsentBy_LEFT_JOIN_Person_SAP_ON_SAP.PersonID=SA.SecondaryConsentBy_&AND=_AND_FSCaseBillMedSocUserID>0_AND_((SA.SecondaryConsentBy>0_AND_SCP.OrganizationID=194)_OR_SAP.OrganizationID=194)__AND_((SA.SecondaryConsentBy>0)_)__AND_SourceCode.SourceCodeID="& RS("SourceCodeID") &"&OrderBy=CALL.CALLID")%>">							
							<%=RS("MedSoc")%>
							</A>
							</FONT></TD>
					</TR>
		...
		<TR>
			...
			<TD ALIGN=CENTER ><FONT SIZE="1" FACE="<%=FontNameHead%>"><B>
				<A target="ReferralSummary" HREF="../Referral/summary_A.sls?<%=("Type=2&StartDate=" & Request.QueryString("StartDate") & "&EndDate=" & Request.QueryString("EndDate") & "&ReportGroupID=0&OrgID=0&CallID=-1&userID=" & Request.QueryString("UserID") & "&userOrgID=" & Request.QueryString("UserOrgID") & "&DSN=" & Request.QueryString("DSN") & "&Options=&ReportID=11&NoLog=1&JOIN=_JOIN_FSCase_fsc_ON_fsc.CallID=Call.CallID_JOIN_SecondaryApproach_SA_ON_SA.CallID=Call.CallID_JOIN_Person_AP_ON_AP.PersonID=SA.SecondaryConsentBy_&AND=_AND_SA.SecondaryApproached=1_AND_(SA.SecondaryApproachOutcome=2_OR_SA.SecondaryConsentOutcome=1)_AND_AP.OrganizationID=194_&OrderBy=CALL.CALLID")%>">
				<%=vTotals(8)%>
				</A>
			</B></FONT></TD>
			<TD ALIGN=CENTER ><FONT SIZE="1" FACE="<%=FontNameHead%>"><B>
...
'Set PrintLine to Print a horizontal line after printing the subtotals.
				...
				<TR>
					...
					<!--
					<TD ALIGN=CENTER ><FONT SIZE="1" FACE="<%=FontNameHead%>"><B>
						<A target="ReferralSummary" HREF="../Referral/summary_A.sls?<%=("Type=2&StartDate=" & Request.QueryString("StartDate") & "&EndDate=" & Request.QueryString("EndDate") & "&ReportGroupID=0&OrgID=0&CallID=-1&userID=" & Request.QueryString("UserID") & "&userOrgID=" & Request.QueryString("UserOrgID") & "&DSN=" & Request.QueryString("DSN") & "&Options=&ReportID=11&NoLog=1&JOIN=_JOIN_FSCase_fsc_ON_fsc.CallID=Call.CallID_JOIN_SecondaryApproach_SA_ON_SA.CallID=Call.CallID_JOIN_Person_AP_ON_AP.PersonID=SA.SecondaryApproachedBy_&AND=_AND_SA.SecondaryApproached=2_AND_SA.SecondaryApproachReason=2_AND_AP.OrganizationID=194_AND_SourceCode.SourceCodeID="& CurrentSourceCodeID &"&OrderBy=CALL.CALLID")%>">
						<%=vOrgTotals(5)%>
						</A>
					</B></FONT></TD>
					-->
					...
					<TD ALIGN=CENTER ><FONT SIZE="1" FACE="<%=FontNameHead%>"><B>
						<A target="ReferralSummary" HREF="../Referral/summary_A.sls?<%=("Type=2&StartDate=" & Request.QueryString("StartDate") & "&EndDate=" & Request.QueryString("EndDate") & "&ReportGroupID=0&OrgID=0&CallID=-1&userID=" & Request.QueryString("UserID") & "&userOrgID=" & Request.QueryString("UserOrgID") & "&DSN=" & Request.QueryString("DSN") & "&Options=&ReportID=11&NoLog=1&JOIN=_JOIN_FSCase_fsc_ON_fsc.CallID=Call.CallID_JOIN_SecondaryApproach_SA_ON_SA.CallID=Call.CallID_JOIN_Person_AP_ON_AP.PersonID=SA.SecondaryConsentBy_&AND=_AND_SA.SecondaryApproached=1_AND_(SA.SecondaryApproachOutcome=2_OR_SA.SecondaryConsentOutcome=1)_AND_AP.OrganizationID=194_AND_SourceCode.SourceCodeID="& CurrentSourceCodeID &"&OrderBy=CALL.CALLID")%>">
						<%=vOrgTotals(8)%>
						</A>
					</B></FONT></TD>
					<TD ALIGN=CENTER ><FONT SIZE="1" FACE="<%=FontNameHead%>"><B>
...
Private Function ReferralOrganizationHeader()
	%>
		...
		<TD  <%=vCurrentColor%> ><FONT SIZE="1" FACE="<%=FontNameData%>"><%=RS("SourceCodeName")%> </TD>
...
Private Function PersonNameHeader()
		...
		%>
			<TD <%=vCurrentColor%> ><FONT SIZE="1" FACE="<%=FontNameData%>"> &nbsp &nbsp &nbsp &nbsp </TD>
		<%
