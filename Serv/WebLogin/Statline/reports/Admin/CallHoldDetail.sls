...
%>
	...
	<TR>
		...
		<TD ALIGN=LEFT WIDTH="20%"><FONT NAME = "<%=FontNameHead%>" SIZE="<%=FontSizeHead%>"><B>Date/Time</TD></B>
		<TD ALIGN=LEFT WIDTH="10%"><FONT NAME = "<%=FontNameHead%>" SIZE="<%=FontSizeHead%>"><B>Hold Time (Seconds)</TD></B>
