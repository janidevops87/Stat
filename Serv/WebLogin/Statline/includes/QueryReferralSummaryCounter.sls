...
<%
' Script using similar logic to QueryReferralSummary.sls, from which it was lifted.
' 
' Created 2/2005 by Scott Plummer
...
'!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!	   
	   ...
	   lvQueryString = ""
	   lvQueryString = "SELECT Count(Referral.ReferralID) AS Ctr "	   
