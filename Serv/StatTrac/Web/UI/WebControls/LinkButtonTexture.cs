...
namespace Statline.StatTrac.Web.UI.WebControls
{
	...
	[ToolboxData("<{0}:LinkButtonTexture runat=server></{0}:LinkButtonTexture>")]
	public class LinkButtonTexture : System.Web.UI.WebControls.LinkButton
	{

		/// <summary>
		/// The default constructor.
		/// </summary>
		public LinkButtonTexture() : base()
		{
		}
