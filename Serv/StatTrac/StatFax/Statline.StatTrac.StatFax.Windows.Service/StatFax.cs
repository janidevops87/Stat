...
{
    public partial class StatFax : ServiceBase
    {
        ...
        protected override void OnStart(string[] args)
        {
            ...
            RunProcess();
            string loggerString = "The " + serviceName + " process has started on " + Environment.MachineName;
            Logger.Write(
                loggerString,
        ...
        public void RunProcess()
        {
            try
            {
                ...
                if (autoProcess != null)
                    ...
                    Logger.Write("StatFax cannot run the service!", Category.Error.ToString(), Convert.ToInt32(Priority.Default));
