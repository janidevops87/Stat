...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template name="ExtendedReferralDetailFS">
    ...
    <xsl:copy-of select="$columnDelimeter"/>
    <xsl:value-of select="ds:FSCaseCreateDateTime"/>
    <xsl:copy-of select="$columnDelimeter"/>
    <xsl:value-of select="ds:FSCaseOpenUserId"/>
    <xsl:copy-of select="$columnDelimeter"/>
    <xsl:value-of select="ds:FSCaseOpenDateTime"/>
    <xsl:copy-of select="$columnDelimeter"/>
    <xsl:value-of select="ds:FSCaseSysEventsUserId"/>
    <xsl:copy-of select="$columnDelimeter"/>
    <xsl:value-of select="ds:FSCaseSysEventsDateTime"/>
    <xsl:copy-of select="$columnDelimeter"/>
    <xsl:value-of select="ds:FSCaseSecCompUserId"/>
    <xsl:copy-of select="$columnDelimeter"/>
    <xsl:value-of select="ds:FSCaseSecCompDateTime"/>
    <xsl:copy-of select="$columnDelimeter"/>
    <xsl:value-of select="ds:FSCaseApproachUserId"/>
    <xsl:copy-of select="$columnDelimeter"/>
    <xsl:value-of select="ds:FSCaseApproachDateTime"/>
    <xsl:copy-of select="$columnDelimeter"/>
    <xsl:value-of select="ds:FSCaseFinalUserId"/>
    <xsl:copy-of select="$columnDelimeter"/>
    <xsl:value-of select="ds:FSCaseFinalDateTime"/>
    <xsl:copy-of select="$columnDelimeter"/>
    <xsl:value-of select="ds:FSCaseUpdate"/>
    <xsl:copy-of select="$columnDelimeter"/>
    <xsl:value-of select="ds:FSCaseUserId"/>
    <xsl:copy-of select="$columnDelimeter"/>
    <xsl:value-of select="ds:FSCaseBillSecondaryUserID"/>
    <xsl:copy-of select="$columnDelimeter"/>
    <xsl:value-of select="ds:FSCaseBillDateTime"/>
    <xsl:copy-of select="$columnDelimeter"/>
    <xsl:value-of select="ds:FSCaseBillApproachUserID"/>
    <xsl:copy-of select="$columnDelimeter"/>
    <xsl:value-of select="ds:FSCaseBillApproachDateTime"/>
    <xsl:copy-of select="$columnDelimeter"/>
    <xsl:value-of select="ds:FSCaseBillMedSocUserID"/>
    <xsl:copy-of select="$columnDelimeter"/>
    <xsl:value-of select="ds:FSCaseBillMedSocDateTime"/>
    <xsl:copy-of select="$columnDelimeter"/>
    ...
    <xsl:copy-of select="$columnDelimeter"/>
    <xsl:value-of select="ds:FSCaseBillFamUnavailDateTime"/>
    <xsl:copy-of select="$columnDelimeter"/>
    <xsl:value-of select="ds:FSCaseBillCryoFormUserId"/>
    <xsl:copy-of select="$columnDelimeter"/>
    <xsl:value-of select="ds:FSCaseBillCryoFormDateTime"/>
    <xsl:copy-of select="$columnDelimeter"/>
    ...
    <xsl:copy-of select="$columnDelimeter"/>
    <xsl:value-of select="ds:SecondaryBrainDeathDate"/>
    <xsl:copy-of select="$columnDelimeter"/>
    <xsl:value-of select="ds:SecondaryBrainDeathTime"/>
    <xsl:copy-of select="$columnDelimeter"/>
    <xsl:value-of select="ds:SecondaryDNRDate"/>
    <xsl:copy-of select="$columnDelimeter"/>
    ...
    <xsl:copy-of select="$columnDelimeter"/>
    <xsl:value-of select="ds:SecondaryLSADate"/>
    <xsl:copy-of select="$columnDelimeter"/>
    ...
    <xsl:copy-of select="$columnDelimeter"/>
    <xsl:value-of select="ds:SecondaryPreTransfusionSampleDrawnDate"/>
    <xsl:copy-of select="$columnDelimeter"/>
    ...
    <xsl:copy-of select="$columnDelimeter"/>
    <xsl:value-of select="ds:SecondaryPreTransfusionSampleHeldDate"/>
    <xsl:copy-of select="$columnDelimeter"/>
    ...
    <xsl:copy-of select="$columnDelimeter"/>
    <xsl:value-of select="ds:SecondaryPostMordemSampleCollectionDate"/>
    <xsl:copy-of select="$columnDelimeter"/>
    ...
    <xsl:copy-of select="$columnDelimeter"/>
    <xsl:value-of select="ds:SecondaryAutopsyDate"/>
    <xsl:copy-of select="$columnDelimeter"/>
    ...
    <xsl:copy-of select="$columnDelimeter"/>
    <xsl:value-of select="ds:SecondaryBodyRefrigerationDate"/>
    <xsl:copy-of select="$columnDelimeter"/>
    ...
    <xsl:copy-of select="$columnDelimeter"/>
    <xsl:value-of select="ds:SecondaryNOKNotifiedDate"/>
    <xsl:copy-of select="$columnDelimeter"/>
    ...
    <xsl:copy-of select="$columnDelimeter"/>
    <xsl:value-of select="ds:SecondaryBodyHoldPlaced"/>
    <xsl:copy-of select="$columnDelimeter"/>
    ...
    <xsl:copy-of select="$columnDelimeter"/>
    <xsl:value-of select="ds:SecondaryCulture1DrawnDate"/>
    <xsl:copy-of select="$columnDelimeter"/>
    ...
    <xsl:copy-of select="$columnDelimeter"/>
    <xsl:value-of select="ds:SecondaryCulture2DrawnDate"/>
    <xsl:copy-of select="$columnDelimeter"/>
