...
SELECT
    @ReportDisplayName          = 'Organization Audit Trail [Internal]',
    @ReportLocalOnly            = 0,
    @ReportVirtualURL           = '/StatTrac/OrganizationAuditTrail',
    @ReportTypeID               = 5,
    @Unused                     = null,
...
IF NOT EXISTS (SELECT * FROM ReportControl WHERE ReportControlName like 'customParamsOrganization')
BEGIN
	insert ReportControl (ReportControlName, ReportParamSectionID) 
	values ('customParamsOrganization', 1) 
END
...
IF NOT EXISTS(SELECT * FROM ReportSortType WHERE ReportSortTypeDisplayname = 'Organization Name' AND ReportSortTypeName = 'OrganizationName')
BEGIN
	INSERT
		ReportSortType
	VALUES
...
IF NOT EXISTS(SELECT * FROM ReportSortType WHERE ReportSortTypeDisplayname = 'ID' AND ReportSortTypeName = 'OrganizationID')
BEGIN
	INSERT
		ReportSortType
	VALUES
...
Select @sortTypeID  = ReportSortTypeID FROM ReportSortType WHERE ReportSortTypeName = 'ChangeDT' AND ReportSortTypeDisplayname = 'Based on D/T'
exec spi_ReportSortTypeConfiguration
	@reportid,
	@sortTypeID	

Select @sortTypeID  = ReportSortTypeID FROM ReportSortType WHERE ReportSortTypeName = 'ChangeUser' AND ReportSortTypeDisplayname = 'StatTrac User'
exec spi_ReportSortTypeConfiguration
	@reportid,
	@sortTypeID	

Select @sortTypeID  = ReportSortTypeID FROM ReportSortType WHERE ReportSortTypeName = 'ChangeType' AND ReportSortTypeDisplayname = 'Change Type'
exec spi_ReportSortTypeConfiguration
	@reportid,
	@sortTypeID	

Select @sortTypeID  = ReportSortTypeID FROM ReportSortType WHERE ReportSortTypeName = 'OrganizationName' AND ReportSortTypeDisplayname = 'Organization Name'
exec spi_ReportSortTypeConfiguration
	@reportid,
	@sortTypeID	

select		
	@sortTypeName = 'OrganizationID',
	@SorTypeDisplayName = 'ID'
