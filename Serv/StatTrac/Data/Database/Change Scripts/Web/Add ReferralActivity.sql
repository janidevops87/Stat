...
SELECT
    @ReportDisplayName          = 'Referral Activity',
    @ReportLocalOnly            = 0,
    @ReportVirtualURL           = '/StatTrac/ReferralActivity',
    @ReportTypeID               = 1,
    @Unused                     = null,
...
INSERT @controlList
VALUES('customParamsDisplayDisposition', 1)
...
if exists (select * from reportsorttype where ReportSortTypeName = @sortTypeName and ReportSortTypeDisplayName = @SorTypeDisplayName)
BEGIN
	INSERT 
		ReportSortType 
		(
...
select		
	@sortTypeName = 'PatientLastName',
	@SorTypeDisplayName = 'Patient First Name'
