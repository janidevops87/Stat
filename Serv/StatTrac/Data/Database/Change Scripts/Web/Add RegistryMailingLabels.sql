...
SELECT
    @ReportDisplayName          = 'Registry Mailing Labels',
    @ReportLocalOnly            = 0,
    @ReportVirtualURL           = '/StatTrac/RegistryMailingLabels',
    @ReportTypeID               = 6,
    @Unused                     = null,
...
SET @ReportControlName = 'customParamsRegistryMailingLabelsSourceControl'	
IF NOT EXISTS (SELECT * FROM ReportControl WHERE ReportControlName like @ReportControlName)
BEGIN
	insert ReportControl (ReportControlName, ReportParamSectionID) 
...
SET @ReportControlName  = 'customParamsRegistryDonorStatusControl'
IF NOT EXISTS (SELECT * FROM ReportControl WHERE ReportControlName like @ReportControlName)
BEGIN
	insert ReportControl (ReportControlName, ReportParamSectionID) 
	values (@ReportControlName, 1) 
...
SET @ReportDateTypeName = 'Registration'
SET @ReportDateTypeDisplayName  = 'Registration'
...
select @RoleName = 'Registry: MailingLabelsReport - Permission'	    
