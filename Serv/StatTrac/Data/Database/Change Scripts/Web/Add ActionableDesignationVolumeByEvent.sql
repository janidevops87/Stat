...
SELECT
    @ReportDisplayName          = 'Actionable Designation Volume by Event',
    @ReportLocalOnly            = 0,
    @ReportVirtualURL           = '/StatTrac/ActionableDesignationVolumeByEvent',
    @ReportTypeID               = 6,
    @Unused                     = null,
...
IF NOT EXISTS (SELECT * FROM ReportControl WHERE ReportControlName like 'customParamsRegistryGroupBy')
BEGIN
	insert ReportControl (ReportControlName, ReportParamSectionID) 
	values ('customParamsRegistryGroupBy', 1) 
END

select 
	@ReportControlID = ReportControlID from ReportControl WHERE ReportControlName = 'customParamsRegistryGroupBy'
...
BEGIN
	exec spi_ReportParamConfiguration
		...
		@ReportControlID	
END	
------customParamsRegistryOutreachEvents----------------------------------------
IF NOT EXISTS (SELECT * FROM ReportControl WHERE ReportControlName like 'customParamsRegistryOutreachEvents')
BEGIN
	insert ReportControl (ReportControlName, ReportParamSectionID) 
	values ('customParamsRegistryOutreachEvents', 1) 
END

select 
	@ReportControlID = ReportControlID from ReportControl WHERE ReportControlName = 'customParamsRegistryOutreachEvents'
...
IF NOT EXISTS (SELECT * FROM ReportControl WHERE ReportControlName like 'customParamsRegistryDonorDesignationStatus')
BEGIN
	insert ReportControl (ReportControlName, ReportParamSectionID) 
	values ('customParamsRegistryDonorDesignationStatus', 1) 
END

select 
	@ReportControlID = ReportControlID from ReportControl WHERE ReportControlName = 'customParamsRegistryDonorDesignationStatus'
