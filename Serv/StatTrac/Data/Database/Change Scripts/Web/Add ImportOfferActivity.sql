...
SELECT
    @ReportDisplayName          = 'Import Offer Activity',
    @ReportLocalOnly            = 0,
    @ReportVirtualURL           = '/StatTrac/ImportOfferActivity',
    @ReportTypeID               = 1,
    @Unused                     = null,
...
VALUES('callParams', 1)
INSERT @controlList
VALUES('customParamsMessageImport', 1)
-- INSERT @controlList
...
-- 3	Change
if exists(select * from ReportDateType where ReportDateTypeName like 'ImportOffer')
BEGIN
	select @ReportDateTypeID = ReportDateTypeID from ReportDateType where ReportDateTypeName like 'ImportOffer'
END
ELSE
BEGIN
	INSERT ReportDateType
	VALUES ('ImportOffer', 'Import Offer')
...
select		
	@sortTypeName = 'MessageCallerOrganization',
	@SorTypeDisplayName = 'Caller Organization'
