...
SELECT
    @ReportDisplayName          = 'Referral Outcome',
    @ReportLocalOnly            = 0,
    @ReportVirtualURL           = '/StatTrac/ReferralOutcome',
    @ReportTypeID               = 1,
    @Unused                     = null,
...
SELECT @WEBPERSONID = 5383 -- lmaclear
IF NOT EXISTS (SELECT * FROM WEBPersonPermission WHERE WebPersonID = @WebPersonID AND PermissionID = @PERMISSIONID)
BEGIN
	exec SPI_WebPersonPermission
                  @WEBPERSONPERMISSIONID        OUTPUT ,
...
INSERT @controlList
VALUES('customParamsCauseOfDeath', 1)
INSERT @controlList
VALUES('customParamsPatientName', 1)
INSERT @controlList
VALUES('customParamsMedicalRecordNumber', 1)
INSERT @controlList
VALUES('customParamsGroupByFacilityControl', 1)
INSERT @controlList
...
IF NOT EXISTS (
		...
		WHERE 
			ReportID = @ReportID
		AND 
			ReportDateTypeName = 'Cardiac'
		AND
			ReportDateTypeDisplayname = 'Cardiac Death'
	 	)
BEGIN
...
INSERT @SORT
VALUES('PreliminaryRefType', 'Referral Type')
INSERT @SORT
VALUES('FinalApproachType', 'Final Approach Type')
INSERT @SORT
VALUES('InitialApproachType', 'Initial Approach Type')
INSERT @SORT
VALUES('PatientFirstName', 'Patient First Name')
INSERT @SORT
VALUES('PatientLastName', 'Patient Last Name')
INSERT @SORT
VALUES('BasedOnDT', 'Based On D/T')
INSERT @SORT
VALUES('ReferralFacility', 'Referral Facility')
INSERT @SORT
VALUES('CallID', 'Referral #')
