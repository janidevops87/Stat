...
SELECT
    @ReportDisplayName          = 'Initial Approacher Summary',
    @ReportLocalOnly            = 0,
    @ReportVirtualURL           = '/StatTrac/InitialApproacherSummary',
    @ReportTypeID               = 4,
    @Unused                     = null,
...
INSERT @controlList
VALUES('customParamsApproacher', 1)
INSERT @controlList
...
select		
	@sortTypeName = 'Approacher',
	@SorTypeDisplayName = 'Approacher'
...
select		
	@sortTypeName = 'TotalReferrals',
	@SorTypeDisplayName = 'Total Referrals'
...
select		
	@sortTypeName = 'RegistryApproach’',
	@SorTypeDisplayName = '# Initial Pre Referral'
