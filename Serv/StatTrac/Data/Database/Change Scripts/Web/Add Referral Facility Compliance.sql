...
SELECT
    @ReportDisplayName          = 'Referral Facility Compliance',
    @ReportLocalOnly            = 0,
    @ReportVirtualURL           = '/StatTrac/ReferralFacilityCompliance',
    @ReportTypeID               = 4,
    @Unused                     = null,
...
INSERT @SORT
VALUES('OrganizationName', 'Referral Facility')	
INSERT @SORT
VALUES('TotalReferrals', ' Total Referrals')
INSERT @SORT
VALUES('TotalRegistered', ' Total Registered')
INSERT @SORT
VALUES('TotalCTOD', ' Total Referrals w/ CTOD Reported')	
INSERT @SORT
VALUES('ClientReportedDeaths', ' Client Reported Deaths')	
INSERT @SORT
VALUES('PercentCompliance', ' % Compliance	String')	
