...
SELECT
    @ReportDisplayName          = 'QA by Error',
    @ReportLocalOnly            = 0,
    @ReportVirtualURL           = '/StatTrac/QAbyError',
    @ReportTypeID               = 4,
    @Unused                     = null,
...
END	
IF NOT EXISTS (SELECT * FROM ReportControl WHERE ReportControlName like 'customParamsSummarizeByMonthControl')
BEGIN
	insert ReportControl (ReportControlName, ReportParamSectionID) 
