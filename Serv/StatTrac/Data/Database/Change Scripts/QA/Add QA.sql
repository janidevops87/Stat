...
SELECT
    @ReportDisplayName          = 'QA',
    @ReportLocalOnly            = 0,
    @ReportVirtualURL           = '/StatTrac/QA',
    @ReportTypeID               = 4,
    @Unused                     = null,
...
SELECT @WEBPERSONID = 7283 -- jhawkins
...
IF NOT EXISTS (SELECT * FROM ReportControl WHERE ReportControlName like 'customParamsPageBreakByEmployeeControl')
BEGIN
	insert ReportControl (ReportControlName, ReportParamSectionID) 
	values ('customParamsPageBreakByEmployeeControl', 1) 
END
IF NOT EXISTS (SELECT * FROM ReportControl WHERE ReportControlName like 'customParamsEmployeeControl')
BEGIN
	insert ReportControl (ReportControlName, ReportParamSectionID) 
	values ('customParamsEmployeeControl', 1) 
END	
IF NOT EXISTS (SELECT * FROM ReportControl WHERE ReportControlName like 'customParamsErrorInfoControl')
BEGIN
	insert ReportControl (ReportControlName, ReportParamSectionID) 
	values ('customParamsErrorInfoControl', 1) 
END	
...
VALUES('customParamsPageBreakByEmployeeControl', 1)
INSERT @controlList
VALUES('customParamsSummarizeByMonthControl', 1)
INSERT @controlList
VALUES('customParamsSummarizeByEmployeeControl', 1)
...
INSERT @SORT
VALUES('EmployeeLast', 'Employee Last Name')	
INSERT @SORT
VALUES('EmployeeFirst', 'Employee First Name')
INSERT @SORT
VALUES('Errortype', 'Error Type')
INSERT @SORT
VALUES('ProcessStep', 'Process Step')	
INSERT @SORT
VALUES('ErrorLocation', 'Error Location')	

INSERT @SORT
VALUES('HowIdentified', 'How Identified')
INSERT @SORT
VALUES('QATrackingNumber', 'Tracking #')	
INSERT @SORT
VALUES('QAErrorLogNumberOfErrors', '# of Errors')		
