...
SELECT
    @ReportDisplayName          = 'QA by CAPA',
    @ReportLocalOnly            = 0,
    @ReportVirtualURL           = '/StatTrac/QAbyCAPA',
    @ReportTypeID               = 4,
    @Unused                     = null,
...
IF NOT EXISTS (SELECT * FROM ReportControl WHERE ReportControlName like 'customParamsCAPANumberControl')
BEGIN
	insert ReportControl (ReportControlName, ReportParamSectionID) 
	values ('customParamsCAPANumberControl', 1) 
END
...
INSERT @SORT
VALUES('QATrackingCAPANumber', 'Capa #')	
INSERT @SORT
VALUES('SourceCode', 'Source Code')
INSERT @SORT
VALUES('CallDateTime', 'Call D/T')
INSERT @SORT
