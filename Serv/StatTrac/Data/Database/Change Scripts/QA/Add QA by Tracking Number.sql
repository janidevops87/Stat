...
SELECT
    @ReportDisplayName          = 'QA by Tracking Number',
    @ReportLocalOnly            = 0,
    @ReportVirtualURL           = '/StatTrac/QAbyTrackingNumber',
    @ReportTypeID               = 4,
    @Unused                     = null,
...
INSERT @SORT
VALUES('QAErrorLogDateTime', 'Date/Time')
INSERT @SORT
VALUES('HowIdentified', 'How Identified')
INSERT @SORT
VALUES('CorrectionLog', 'Correction Log')	
INSERT @SORT
