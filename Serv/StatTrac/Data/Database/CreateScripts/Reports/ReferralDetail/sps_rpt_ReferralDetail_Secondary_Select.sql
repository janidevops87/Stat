if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[sps_rpt_ReferralDetail_Secondary_Select]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
	BEGIN
		PRINT 'Dropping Procedure: sps_rpt_ReferralDetail_Secondary_Select'
		DROP  Procedure  sps_rpt_ReferralDetail_Secondary_Select
	END
...
CREATE PROCEDURE sps_rpt_ReferralDetail_Secondary_Select
     @CallID            int          = null,
     @DisplayMT			int			 = null
