...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[sps_rpt_FSConversionRateAll_Test_ValvesApproch]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
Begin
	drop procedure [dbo].[sps_rpt_FSConversionRateAll_Test_ValvesApproch]
End
go
...
CREATE      PROCEDURE sps_rpt_FSConversionRateAll_Test_ValvesApproch
...
/********************************* BEGIN ERROR HANDLING *********************************************/
	IF @@ERROR <> 0 
	BEGIN
	   PRINT 'sps_rpt_FSConversionRateAll_Test_ValvesApproch'
	   PRINT ''
	END
	ELSE
	BEGIN
	   PRINT 'SUCCESS - 3.0 sps_rpt_FSConversionRateAll_Test_ValvesApproch'
	   PRINT ''
	END
	GO
/********************************* END ERROR HANDLING *********************************************/
