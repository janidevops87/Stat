...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[sps_rpt_FSConversionRateAll_Test_SkinConsent]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
Begin
	drop procedure [dbo].[sps_rpt_FSConversionRateAll_Test_SkinConsent]
End
go
...
CREATE      PROCEDURE sps_rpt_FSConversionRateAll_Test_SkinConsent
...
/********************************* BEGIN ERROR HANDLING *********************************************/
	IF @@ERROR <> 0 
	BEGIN
	   PRINT 'sps_rpt_FSConversionRateAll_Test_SkinConsent'
	   PRINT ''
	END
	ELSE
	BEGIN
	   PRINT 'SUCCESS - 3.0 sps_rpt_FSConversionRateAll_Test_SkinConsent'
	   PRINT ''
	END
	GO
/********************************* END ERROR HANDLING *********************************************/
