if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[sps_rpt_FSConversionRateAll_Test_TotalTotal]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
Begin
	drop procedure [dbo].[sps_rpt_FSConversionRateAll_Test_TotalTotal]
	PRINT 'Dropping sps_rpt_FSConversionRateAll_Test_TotalTotal'
End
go

	PRINT 'Creating sps_rpt_FSConversionRateAll_Test_TotalTotal'
	GO
...
CREATE       PROCEDURE sps_rpt_FSConversionRateAll_Test_TotalTotal
