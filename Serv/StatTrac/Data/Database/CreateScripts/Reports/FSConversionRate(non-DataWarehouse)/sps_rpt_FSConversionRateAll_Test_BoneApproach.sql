...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[sps_rpt_FSConversionRateAll_Test_BoneApproach]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
Begin
	drop procedure [dbo].[sps_rpt_FSConversionRateAll_Test_BoneApproach]
End
go
...
CREATE      PROCEDURE sps_rpt_FSConversionRateAll_Test_BoneApproach
...
/********************************* BEGIN ERROR HANDLING *********************************************/
	IF @@ERROR <> 0 
	BEGIN
	   PRINT 'sps_rpt_FSConversionRateAll_Test_BoneApproach'
	   PRINT ''
	END
	ELSE
	BEGIN
	   PRINT 'SUCCESS - 3.0 sps_rpt_FSConversionRateAll_Test_BoneApproach'
	   PRINT ''
	END
	GO
/********************************* END ERROR HANDLING *********************************************/
