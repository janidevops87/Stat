 /****************************************************************************** 
**  File:  
**  Name: spu_Audit_TcssListCallType.sql 
**  Desc:  
** 
**  Date:    Author:    Description: 
**  --------   --------   ------------------------------------------- 
**  06/27/2011  jim hawkins   Update Audit records for DBO.TcssListCallType**   
*******************************************************************************/
SET QUOTED_IDENTIFIER ON   
 GO
   SET ANSI_NULLS ON     
 GO
   if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[spu_Audit_TcssListCallType]') and OBJECTPROPERTY(id,N'IsProcedure') = 1) 
 BEGIN
 drop procedure [dbo].[spu_Audit_TcssListCallType]
 PRINT 'Drop Sproc: spu_Audit_TcssListCallType'  
 END   
 GO
 PRINT 'Create Sproc: spu_Audit_TcssListCallType'  
 GO
   create procedure "spu_Audit_TcssListCallType" 
