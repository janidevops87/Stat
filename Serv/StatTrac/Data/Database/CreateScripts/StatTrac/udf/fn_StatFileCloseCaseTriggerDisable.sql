...
IF EXISTS (SELECT * FROM dbo.sysobjects where id = object_id(N'[dbo].[fn_StatFileCloseCaseTriggerDisable]') and xtype in (N'FN', N'IF', N'TF'))
BEGIN
	PRINT 'DROP FUNCTION [dbo].[fn_StatFileCloseCaseTriggerDisable]'
	DROP FUNCTION [dbo].[fn_StatFileCloseCaseTriggerDisable]
END
	PRINT 'CREATE FUNCTION dbo.fn_StatFileCloseCaseTriggerDisable'

GO


CREATE FUNCTION dbo.fn_StatFileCloseCaseTriggerDisable
	(
...
/******************************************************************************
**		File: 
**		Name: dbo.fn_StatFileCloseCaseTriggerDisable
**		Desc: 
**
