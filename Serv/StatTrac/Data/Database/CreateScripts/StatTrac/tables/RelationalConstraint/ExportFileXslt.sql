...
**	Name: ExportFileXslt
**	Desc: Relational Constraints for ExportFileXslt
**	Auth: Bret Knoll
**	Date: 02/26/2009
*******************************************************************************
**	Change History
...
PRINT 'Drop All Foreign Keys to ExportFileXslt'
...
BEGIN
	...
	SELECT @TableNameId = Id FROM sysobjects WHERE name = 'ExportFileXslt'
