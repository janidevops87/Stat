...
namespace Statline.IdentityServer.Common.FeatureFolders
{
    public static class RazorExtensions
    {
        public static void ConfigureFeatureFolders(this RazorViewEngineOptions options)
        {
            ...
            // For _ViewImports and _ViewStart
            options.AreaViewLocationFormats.Add("/Areas/{0}.cshtml");
        ...
        public static void ConfigureFeatureFoldersSideBySideWithStandardViews(
