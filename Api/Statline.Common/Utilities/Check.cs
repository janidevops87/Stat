...
namespace Statline.Common.Utilities
{
    ...
    {
        private static readonly CheckMessageFormatter MessagesFormatter =
        ...
        public static IEnumerable<string> HasNoEmpties(IEnumerable<string> value, string parameterName)
        {
            NotNull(value, parameterName);
