...
import { CustomParamsMessageActivityModel } from './CustomParamsMessageActivityModel';
...
@Component({
  templateUrl: './customParamsMessageActivity.component.html'
})
export class CustomParamsMessageActivityComponent implements CustomParamComponent {
  @Input() data: any;
  method = new CommonMethods();
  model = new CustomParamsMessageActivityModel();
